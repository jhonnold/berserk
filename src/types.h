...
#define NON_PAWN_CORRECTION_SIZE  131072
#define NON_PAWN_CORRECTION_MASK  (NON_PAWN_CORRECTION_SIZE - 1)
...
struct ThreadData {
  ...
  int16_t wNonPawnCorrection[NON_PAWN_CORRECTION_SIZE];
  int16_t bNonPawnCorrection[NON_PAWN_CORRECTION_SIZE];
