...
INLINE void CopyData(const unsigned char* in) {
  ...
  OUTPUT_WEIGHTS[0]  = 427;
  OUTPUT_WEIGHTS[1]  = 251;
  OUTPUT_WEIGHTS[2]  = 592;
  OUTPUT_WEIGHTS[3]  = 370;
  OUTPUT_WEIGHTS[4]  = 704;
  OUTPUT_WEIGHTS[5]  = -785;
  OUTPUT_WEIGHTS[6]  = -893;
  OUTPUT_WEIGHTS[7]  = -387;
  OUTPUT_WEIGHTS[8]  = -742;
  OUTPUT_WEIGHTS[9]  = -397;
  OUTPUT_WEIGHTS[10] = 1016;
  OUTPUT_WEIGHTS[11] = 410;
  OUTPUT_WEIGHTS[12] = -363;
  OUTPUT_WEIGHTS[13] = -529;
  OUTPUT_WEIGHTS[14] = -358;
  OUTPUT_WEIGHTS[15] = -703;
  OUTPUT_WEIGHTS[16] = 440;
  OUTPUT_WEIGHTS[17] = -590;
  OUTPUT_WEIGHTS[18] = 547;
  OUTPUT_WEIGHTS[19] = -395;
  OUTPUT_WEIGHTS[20] = 744;
  OUTPUT_WEIGHTS[21] = 609;
  OUTPUT_WEIGHTS[22] = -480;
  OUTPUT_WEIGHTS[23] = 703;
  OUTPUT_WEIGHTS[24] = -531;
  OUTPUT_WEIGHTS[25] = 510;
  OUTPUT_WEIGHTS[26] = 687;
  OUTPUT_WEIGHTS[27] = -235;
  OUTPUT_WEIGHTS[28] = 1527;
  OUTPUT_WEIGHTS[29] = -182;
  OUTPUT_WEIGHTS[30] = -517;
