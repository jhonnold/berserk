...
const Score PAWN_PSQT[2][32] = {{
 ...
 S( 119, 199), S( 116, 224), S(  84, 220), S( 114, 195),
 S(  81, 135), S(  63, 154), S(  81, 100), S(  85,  80),
 S(  79, 117), S(  80, 103), S(  66,  87), S(  61,  79),
 S(  75,  92), S(  72,  95), S(  67,  81), S(  75,  81),
 S(  67,  83), S(  68,  86), S(  67,  81), S(  69,  90),
 S(  75,  87), S(  82,  93), S(  80,  85), S(  87,  87),
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
},{
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
 S( 158, 153), S(  66, 157), S( 163, 151), S( 101, 197),
 S(  96,  82), S( 105,  74), S( 119,  49), S(  93,  68),
 S(  70,  79), S(  86,  74), S(  70,  65), S(  86,  68),
 S(  59,  72), S(  76,  77), S(  68,  70), S(  85,  73),
 S(  40,  71), S(  73,  72), S(  71,  75), S(  79,  85),
 S(  48,  81), S(  89,  83), S(  80,  83), S(  88,  98),
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
}};

const Score KNIGHT_PSQT[2][32] = {{
 S(-188,  54), S(-196,  76), S(-168,  85), S(-129,  65),
 S(-117,  83), S( -98,  86), S( -73,  69), S( -69,  70),
 S( -59,  64), S( -66,  71), S( -69,  81), S( -81,  82),
 ...
 S(-239, -96), S(-277,  48), S(-140,  34), S( -69,  60),
 S( -92,  16), S( -23,  39), S( -60,  69), S( -75,  71),
...
const Score BISHOP_PSQT[2][32] = {{
 ...
 S(  16, 121), S(  18, 121), S( -12, 102), S(  19, 110),
 S(  10, 119), S(  35, 112), S(  22, 116), S(  15, 132),
 S(  31, 103), S(  19, 116), S(  30, 115), S(  38, 112),
 S(  24,  95), S(  44, 108), S(  28,  92), S(  32, 108),
 S(  29,  92), S(  28,  65), S(  43,  83), S(  25, 103),
 S(  21,  73), S(  42,  87), S(  29, 107), S(  34, 103),
},{
 S( -59,  76), S(  45,  98), S( -39, 107), S( -65, 110),
 S(   4,  74), S( -32, 103), S(  -8, 119), S(  20, 101),
 S(  35, 107), S(   6, 109), S(   8, 103), S(  20, 111),
 S(   7, 103), S(  36, 106), S(  39, 110), S(  34, 112),
 S(  46,  81), S(  38, 103), S(  40, 112), S(  34, 113),
...
const Score ROOK_PSQT[2][32] = {{
 S(-106, 228), S( -97, 233), S( -95, 235), S(-125, 238),
 S( -93, 221), S( -98, 231), S( -82, 229), S( -66, 212),
 S(-109, 230), S( -75, 224), S( -85, 225), S( -85, 219),
 S(-103, 244), S( -88, 239), S( -76, 236), S( -73, 220),
 S(-104, 238), S( -99, 238), S( -94, 235), S( -87, 225),
 S(-108, 228), S( -97, 215), S( -93, 218), S( -93, 216),
 S(-103, 212), S( -99, 216), S( -86, 212), S( -83, 204),
 S(-105, 220), S( -97, 212), S( -95, 217), S( -88, 204),
},{
 S( -40, 212), S( -94, 237), S(-155, 249), S( -97, 229),
 S( -74, 203), S( -59, 214), S( -81, 218), S( -94, 219),
 S( -96, 207), S( -44, 202), S( -70, 195), S( -52, 195),
...
const Score QUEEN_PSQT[2][32] = {{
 S(-105, 395), S( -26, 301), S(  15, 299), S(   8, 322),
 S( -28, 329), S(  -3, 291), S(   8, 321), S(   5, 320),
 S(   2, 303), S(  11, 292), S(   7, 319), S(  23, 317),
 S(  -4, 329), S(   4, 342), S(   9, 341), S(   0, 344),
 S(   5, 305), S(  -9, 352), S(  -4, 341), S( -11, 362),
 S(  -4, 289), S(  -1, 305), S(  -4, 321), S(  -9, 322),
 S(   0, 257), S(  -3, 270), S(   3, 271), S(   3, 285),
 S( -14, 279), S( -14, 275), S( -12, 279), S(  -9, 285),
},{
 S(  44, 282), S( 107, 258), S( -86, 383), S(  25, 283),
 S(  33, 275), S(  23, 263), S(  18, 305), S(   2, 330),
 S(  34, 270), S(  18, 259), S(  37, 284), S(  24, 313),
 S(   1, 310), S(  13, 313), S(  30, 282), S(  10, 338),
 S(  10, 282), S(   8, 307), S(  14, 309), S(  -6, 357),
 S(   5, 250), S(  12, 275), S(  12, 299), S(  -3, 321),
 S(  23, 214), S(  20, 217), S(  15, 242), S(   7, 282),
 S(  13, 246), S( -16, 264), S( -12, 251), S(  -5, 266),
}};

const Score KING_PSQT[2][32] = {{
 S( 229,-135), S( 127, -57), S( -21, -15), S( 112, -43),
 S( -97,  57), S( -31,  69), S(  -7,  57), S(  33,  24),
 S(  11,  43), S(  -3,  74), S(  26,  64), S( -12,  67),
 S(  14,  39), S(  12,  60), S( -11,  61), S( -24,  53),
 S( -28,  25), S(  17,  38), S(  32,  31), S( -31,  34),
 S( -25,  -2), S(   1,  14), S(  -2,  11), S( -14,   5),
 S(   6, -22), S( -21,  12), S( -24,  -4), S( -30, -13),
 S(  13, -81), S(  18, -38), S(   6, -37), S( -46, -35),
},{
 S( -30,-135), S(-299,  56), S(   9, -35), S( -47, -34),
 S(-213,  16), S( -94,  88), S( -75,  69), S( 144,  14),
 S(-113,  29), S(  41,  86), S( 145,  71), S(  78,  61),
 S( -95,  17), S(  15,  57), S(   2,  72), S(   3,  57),
 S( -80,   4), S( -49,  38), S(   5,  36), S( -11,  35),
 S(  -5, -14), S(  23,  11), S(   6,  12), S(  11,   7),
...
const Score KNIGHT_MOBILITIES[9] = {
 S(-157, -33), S(-115,  42), S( -97,  81), S( -85,  95),
 S( -77, 108), S( -70, 121), S( -62, 124), S( -54, 126),
 S( -46, 116),};
...
const Score QUEEN_MOBILITIES[28] = {
 S(-1878,-1383), S(-129,-329), S( -77, 132), S( -55, 264),
 S( -42, 302), S( -36, 314), S( -37, 346), S( -35, 368),
 S( -33, 386), S( -29, 390), S( -26, 395), S( -23, 395),
 S( -23, 401), S( -18, 400), S( -19, 402), S( -11, 393),
 S( -12, 393), S( -13, 393), S(  -5, 372), S(  12, 343),
 S(  30, 308), S(  43, 270), S(  80, 235), S( 124, 146),
 S(  92, 154), S( 218,  23), S(  42,  40), S(  63,  -6),
};
...
const Score CONNECTED_PAWN[8] = {
 S(   0,   0), S(  80,  45), S(  25,  37), S(   9,  12),
 S(   6,   3), S(   5,   2), S(   2,  -1), S(   0,   0),
};

const Score CANDIDATE_PASSER[8] = {
 S(   0,   0), S(   0,   0), S( 187, 160), S(  16,  77),
 S( -13,  61), S( -23,  38), S( -37,  16), S(   0,   0),
};

const Score CANDIDATE_EDGE_DISTANCE = S(4, -11);

const Score PASSED_PAWN[8] = {
 S(   0,   0), S( 124, 188), S(  48, 186), S(  16, 116),
...
const Score PASSED_PAWN_ADVANCE_DEFENDED[5] = {
 S(   0,   0), S(  86, 261), S(  14, 139), S(   7,  48), S(  11,  10),
};
...
const Score KNIGHT_THREATS[6] = { S(0, 20), S(-4, 49), S(35, 37), S(85, 11), S(69, -47), S(0, 0),};

const Score BISHOP_THREATS[6] = { S(2, 20), S(22, 38), S(-66, 81), S(71, 21), S(60, 41), S(320, 369),};

const Score ROOK_THREATS[6] = { S(-1, 23), S(31, 44), S(33, 55), S(8, 21), S(45, -24), S(378, 404),};
...
const Score PAWN_SHELTER[4][8] = {
 { S(-21, -4), S(33, 92), S(-4, 50), S(-15, 7), S(7, -5), S(37, -26), S(34, -49), S(0, 0),},
 { S(-44, 1), S(-3, 73), S(-21, 44), S(-31, 19), S(-27, 7), S(24, -19), S(32, -33), S(0, 0),},
 { S(-23, -12), S(8, 85), S(-38, 34), S(-14, 6), S(-15, -4), S(-5, -9), S(28, -20), S(0, 0),},
 { S(-37, 17), S(30, 72), S(-59, 35), S(-30, 29), S(-28, 22), S(-16, 14), S(-25, 23), S(0, 0),},
};

const Score PAWN_STORM[4][8] = {
 { S(-19, -13), S(-24, -3), S(-24, -8), S(-28, 3), S(-57, 29), S(57, 80), S(272, 75), S(0, 0),},
 { S(-12, -1), S(3, -7), S(3, -5), S(-11, 8), S(-27, 20), S(-33, 83), S(93, 132), S(0, 0),},
 { S(24, -4), S(25, -8), S(23, -5), S(7, 4), S(-15, 18), S(-49, 75), S(58, 97), S(0, 0),},
 { S(-2, -5), S(2, -12), S(14, -10), S(3, -12), S(-19, 4), S(-20, 48), S(-37, 121), S(0, 0),},
};

const Score BLOCKED_PAWN_STORM[8] = {
 S(-15, -42), S(37, -52), S(19, -37), S(16, -31), S(4, -25), S(6, -84), S(0, 0), S(0, 0),
};
