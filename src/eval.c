...
// clang-format off
const Score MATERIAL_VALUES[7] = { S(86, 170), S(362, 531), S(384, 534), S(513, 916), S(1290, 1498), S(   0,   0), S(   0,   0) };

const Score BISHOP_PAIR = S(19, 90);

const Score PAWN_PSQT[32] = {
 S(  -9,  -1), S(   0,   0), S(   0,   0), S(   0,   0),
 S(  86, 198), S(  22, 220), S( 107, 190), S( 135, 178),
 S(  -3,  67), S(  -1,  58), S(  40,  30), S(  32,  12),
 S( -10,  22), S(   3,  12), S(  -2,   0), S(  26,  -9),
 S( -12,   9), S(  -4,   5), S(   1,  -5), S(   2,   0),
 S( -12,  -1), S(   1,  -2), S(  -5,   4), S(   4,  10),
 S(  -7,  -5), S(   1,   3), S(  -7,  14), S(  -3,  23),
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
};

const Score KNIGHT_PSQT[32] = {
 S(-150, -43), S( -72,  36), S( -86,  64), S(  11,  30),
 S(   9,  18), S(  -1,  37), S(  42,  17), S(  71,  39),
 S(  13,  11), S(  14,  26), S(  31,  53), S(  53,  36),
 S(  25,  32), S(  19,  34), S(  28,  48), S(  30,  57),
 S(  17,  46), S(  41,  41), S(  22,  72), S(  28,  70),
 S(  -6,  18), S(   9,  42), S(   4,  50), S(  23,  70),
 S(   0,  53), S(  -9,  51), S(   3,  31), S(   6,  59),
 S( -52,  18), S(  -3,  27), S(   3,  38), S(   6,  57),
};

const Score BISHOP_PSQT[32] = {
 S( -35,  84), S( -30,  76), S(-106,  82), S( -91,  86),
 S( -32,  76), S( -20,  81), S(   0,  74), S(  -6,  68),
 S(   4,  58), S(  -3,  74), S(  26,  73), S(  24,  58),
 S( -16,  57), S(  14,  64), S(   5,  54), S(  28,  59),
 S(   7,  42), S(   8,  46), S(   4,  60), S(  19,  54),
 S(   9,  51), S(  15,  49), S(   8,  59), S(   8,  63),
 S(  16,  25), S(  20,  42), S(  15,  35), S(  -4,  57),
 S(  23,  42), S(  15,  47), S(   1,  56), S( -11,  53),
};

const Score ROOK_PSQT[32] = {
 S(  37, 137), S(  28, 142), S(  -3, 150), S(   0, 142),
 S(  30, 106), S(  13, 115), S(  49, 104), S(  52, 109),
 S(  14, 114), S(  73,  99), S(  66, 109), S(  93,  88),
 S(  11, 121), S(  28, 117), S(  42, 120), S(  62, 114),
 S( -14, 117), S(  -2, 127), S(  -6, 129), S(   2, 123),
 S( -22, 105), S(  -3, 110), S( -13, 111), S(  -4, 104),
 S( -49, 114), S(  -8,  93), S(  -3,  96), S(  -3,  93),
 S( -17, 116), S( -12, 113), S(  -7, 113), S(  -1, 100),
};

const Score QUEEN_PSQT[32] = {
 S(  66, 297), S(  96, 278), S(  80, 317), S(  71, 332),
 S(  40, 308), S( -11, 327), S(  47, 341), S(  21, 362),
 S(  57, 295), S(  70, 294), S(  43, 340), S(  60, 342),
 S(  80, 269), S(  63, 326), S(  53, 328), S(  46, 358),
 S(  64, 266), S(  67, 286), S(  54, 308), S(  37, 336),
 S(  64, 220), S(  68, 240), S(  52, 271), S(  51, 252),
 S(  60, 197), S(  69, 186), S(  72, 171), S(  59, 218),
 S(  64, 202), S(  58, 182), S(  52, 182), S(  56, 200),
};

const Score KING_PSQT[32] = {
 S(  34,-235), S( 182, -79), S( 118, -57), S( 129, -54),
 S( -15, -77), S( 145,  13), S( 187,  -4), S( 153, -21),
 S( -14, -21), S( 220,   0), S( 215,  15), S( 149,   0),
 S(   8, -11), S( 229,   0), S( 195,  27), S( 112,  36),
 S( -37, -13), S( 150,  11), S( 208,  28), S( 163,  44),
 S( -57,  -6), S(  14,  26), S(  88,  35), S( 129,  38),
 S( -45, -22), S( -48,  21), S( -54,  50), S( -57,  50),
 S( -50, -99), S( -43, -21), S( -71,  13), S( -53, -23),
};

const Score KNIGHT_POST_PSQT[32] = {
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
 S(  17,  23), S(  14,  51), S(  42,  20), S(  29,  38),
 S(  16,  30), S(  34,  39), S(  50,  40), S(  57,  48),
 S(   5,  26), S(  12,  30), S(  30,  23), S(  36,  38),
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
};
...
const Score BISHOP_POST_PSQT[32] = {
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
 S(   8,  14), S(  25,  15), S(  39,   2), S(  40,   3),
 S(  23,  19), S(  33,  16), S(  50,  14), S(  57,  15),
 S(   0,  21), S(  37,  17), S(  40,  17), S(  53,  21),
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
};
...
const Score KNIGHT_MOBILITIES[9] = {
 S( -31, -98), S( -15, -15), S(  -4,  37), S(   5,  63),
 S(  12,  75), S(  15,  90), S(  22,  93), S(  29,  90),
 S(  39,  74),};

const Score BISHOP_MOBILITIES[14] = {
 S( -20, -70), S( -11, -12), S(  -4,  24), S(   5,  55),
 S(  17,  75), S(  22,  95), S(  25, 108), S(  22, 115),
 S(  23, 122), S(  28, 124), S(  32, 123), S(  50, 111),
 S(  59, 125), S(  94,  88),};

const Score ROOK_MOBILITIES[15] = {
 S(-107,-175), S( -21,   6), S(  -8,  59), S(  -5,  74),
 S(  -8,  99), S(  -8, 118), S(  -9, 127), S(  -5, 132),
 S(   2, 135), S(   9, 136), S(  17, 138), S(  24, 134),
 S(  33, 127), S(  45, 112), S( 103,  71),};

const Score QUEEN_MOBILITIES[28] = {
 S(-281,1254), S(  28,-187), S(  13,  43), S(  44, 129),
 S(  50, 219), S(  49, 296), S(  50, 330), S(  53, 349),
 S(  57, 362), S(  62, 374), S(  65, 380), S(  70, 383),
 S(  72, 385), S(  74, 387), S(  76, 386), S(  76, 386),
 S(  74, 383), S(  73, 377), S(  74, 365), S(  81, 347),
 S(  88, 326), S( 103, 296), S( 109, 270), S( 122, 238),
 S( 116, 216), S( 113, 178), S( 105, 195), S( 190, 116),
};

const Score KNIGHT_OUTPOST_REACHABLE = S(4, 14);

const Score BISHOP_OUTPOST_REACHABLE = S(4, 0);

const Score BISHOP_TRAPPED = S(-12, -111);

const Score ROOK_TRAPPED = S(-42, -61);

const Score ROOK_OPEN_FILE = S(21, 26);

const Score ROOK_SEMI_OPEN = S(0, 24);

const Score ROOK_OPPOSITE_KING = S(31, -35);

const Score ROOK_ADJACENT_KING = S(21, -56);

const Score DOUBLED_PAWN = S(-11, -28);

const Score OPPOSED_ISOLATED_PAWN = S(-8, -15);

const Score OPEN_ISOLATED_PAWN = S(-11, -20);

const Score BACKWARDS_PAWN = S(-6, -21);

const Score CONNECTED_PAWN[8] = {
 S(   0,   0), S( 147,  10), S(  47,  26), S(  14,  16),
 S(   5,   6), S(   3,   2), S(  -1,  -2), S(   0,   0),
};

const Score PASSED_PAWN[8] = {
 S(   0,   0), S(  86, 199), S(  46, 247), S(  17, 146),
 S(  -7,  83), S(  -8,  45), S(  -7,  47), S(   0,   0),
};

const Score PASSED_PAWN_EDGE_DISTANCE = S(-9, -7);

const Score PASSED_PAWN_KING_PROXIMITY = S(-9, 33);

const Score PASSED_PAWN_ADVANCE_DEFENDED = S(12, 16);

const Score KNIGHT_THREATS[6] = { S(3, 17), S(-3, 19), S(26, 40), S(41, 32), S(29, 56), S(0, 0),};

const Score BISHOP_THREATS[6] = { S(2, 11), S(19, 58), S(7, 7), S(33, 35), S(33, 34), S(0, 0),};

const Score ROOK_THREATS[6] = { S(6, 14), S(13, 28), S(15, 31), S(1, 26), S(37, 27), S(0, 0),};

const Score KING_THREATS[6] = { S(103, 85), S(25, 64), S(-33, 37), S(73, 33), S(0, 0), S(0, 0),};
