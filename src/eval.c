...
const Score PAWN_PSQT[2][32] = {{
 ...
 S( 185, 392), S( 217, 497), S( 157, 461), S( 226, 414),
 S( 132, 321), S( 104, 338), S( 122, 233), S( 139, 192),
 S(  95, 275), S( 116, 242), S(  81, 211), S(  73, 173),
 S(  72, 211), S(  59, 200), S(  66, 177), S(  70, 148),
 S(  72, 204), S(  51, 179), S(  66, 175), S(  64, 185),
 S(  60, 196), S(  87, 188), S( 115, 199), S(  93, 179),
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
},{
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
 S( 272, 302), S( 116, 354), S( 422, 296), S( 211, 433),
 S( 166, 210), S( 184, 184), S( 201, 140), S( 154, 166),
 S(  81, 199), S( 128, 191), S(  95, 170), S( 116, 156),
 S(  41, 174), S(  61, 172), S(  62, 158), S(  83, 135),
 S(  21, 182), S(  52, 155), S(  60, 169), S(  82, 176),
 S(   7, 187), S( 101, 171), S( 109, 193), S(  82, 195),
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
}};

const Score KNIGHT_PSQT[2][32] = {{
 S(-331, 182), S(-362, 249), S(-301, 279), S(-229, 237),
 S(-185, 252), S(-146, 272), S( -97, 247), S( -84, 249),
 S( -59, 205), S( -74, 238), S( -87, 265), S(-107, 273),
 S( -84, 273), S( -76, 263), S( -51, 264), S( -71, 274),
 S( -84, 260), S( -76, 255), S( -48, 278), S( -61, 284),
 S(-129, 217), S(-109, 219), S( -88, 232), S( -93, 267),
 S(-149, 226), S(-117, 207), S(-110, 229), S( -97, 224),
 S(-193, 226), S(-119, 221), S(-118, 223), S( -97, 242),
},{
 S(-426,-144), S(-490, 174), S(-226, 154), S( -74, 210),
 S(-124, 121), S(  18, 177), S( -59, 235), S(-103, 248),
 S( -26, 156), S(-108, 208), S(  -4, 153), S( -42, 227),
 S( -61, 233), S( -59, 228), S( -42, 246), S( -62, 271),
 S( -73, 261), S( -90, 247), S( -37, 270), S( -71, 301),
 S( -86, 206), S( -55, 202), S( -75, 221), S( -65, 259),
 S( -88, 220), S( -66, 211), S( -94, 212), S( -95, 219),
 S(-106, 234), S(-132, 228), S( -97, 213), S( -82, 242),
}};

const Score BISHOP_PSQT[2][32] = {{
 S( -74, 329), S(-110, 357), S( -79, 322), S(-138, 368),
 S( -32, 317), S( -52, 284), S(  25, 307), S( -11, 340),
 S(   9, 327), S(  18, 325), S( -46, 290), S(  21, 313),
 S(   2, 325), S(  50, 314), S(  27, 326), S(  10, 359),
 S(  42, 299), S(  18, 323), S(  41, 321), S(  61, 314),
 S(  33, 277), S(  74, 306), S(  41, 271), S(  49, 304),
 S(  45, 269), S(  40, 208), S(  71, 253), S(  34, 291),
 S(  27, 220), S(  69, 263), S(  42, 300), S(  50, 297),
},{
 S(-143, 233), S(  66, 289), S(-102, 302), S(-156, 311),
 S( -14, 219), S( -83, 289), S( -36, 322), S(  22, 291),
 S(  54, 301), S(  -8, 316), S(  -5, 296), S(  18, 314),
 S(  -7, 302), S(  54, 306), S(  59, 318), S(  49, 317),
 S(  75, 250), S(  56, 297), S(  64, 317), S(  53, 316),
 S(  61, 255), S(  93, 282), S(  58, 270), S(  48, 326),
 S(  67, 211), S(  64, 211), S(  62, 278), S(  53, 291),
 S(  64, 170), S(  50, 315), S(  29, 307), S(  64, 289),
}};

const Score ROOK_PSQT[2][32] = {{
 S(-296, 542), S(-287, 561), S(-281, 568), S(-347, 577),
 S(-270, 527), S(-284, 554), S(-252, 554), S(-215, 515),
 S(-308, 551), S(-239, 540), S(-264, 544), S(-256, 529),
 S(-286, 567), S(-265, 565), S(-238, 558), S(-232, 526),
 S(-288, 550), S(-284, 558), S(-265, 543), S(-256, 532),
 S(-297, 531), S(-276, 507), S(-266, 511), S(-266, 510),
 S(-286, 490), S(-279, 507), S(-253, 499), S(-245, 485),
 S(-291, 511), S(-275, 498), S(-272, 509), S(-255, 483),
},{
 S(-163, 511), S(-325, 596), S(-390, 593), S(-281, 552),
 S(-219, 486), S(-206, 517), S(-234, 517), S(-269, 523),
 S(-268, 503), S(-162, 500), S(-230, 483), S(-190, 481),
 S(-259, 520), S(-200, 516), S(-217, 498), S(-211, 506),
 S(-287, 499), S(-255, 510), S(-258, 502), S(-234, 511),
 S(-269, 448), S(-229, 444), S(-244, 460), S(-240, 483),
 S(-255, 443), S(-207, 424), S(-240, 444), S(-233, 464),
 S(-280, 467), S(-238, 460), S(-258, 462), S(-236, 461),
}};

const Score QUEEN_PSQT[2][32] = {{
 S(-160, 803), S(  12, 600), S(  77, 623), S(  61, 677),
 S(  -8, 658), S(  43, 588), S(  60, 663), S(  60, 658),
 S(  52, 610), S(  74, 585), S(  64, 641), S( 100, 642),
 S(  48, 651), S(  58, 691), S(  74, 680), S(  47, 698),
 S(  60, 610), S(  34, 708), S(  41, 685), S(  28, 734),
 S(  44, 578), S(  50, 607), S(  44, 648), S(  34, 652),
 S(  48, 509), S(  45, 538), S(  58, 546), S(  55, 578),
 S(  19, 556), S(  19, 558), S(  25, 563), S(  30, 573),
},{
 S( 140, 599), S( 265, 558), S(-124, 797), S( 107, 580),
 S( 120, 570), S(  86, 579), S(  85, 619), S(  47, 689),
 S( 121, 559), S( 101, 520), S( 125, 590), S(  97, 638),
 S(  50, 648), S(  73, 652), S( 111, 586), S(  68, 699),
 S(  68, 583), S(  63, 637), S(  77, 638), S(  39, 728),
 S(  60, 512), S(  76, 561), S(  77, 613), S(  44, 654),
 S(  89, 444), S(  89, 440), S(  80, 486), S(  66, 571),
 S(  71, 501), S(   7, 552), S(  22, 512), S(  39, 539),
}};

const Score KING_PSQT[2][32] = {{
 S( 514,-402), S( 197,-164), S(  37,-126), S( 274,-160),
 S(-253, 101), S(-301, 238), S(-149, 155), S( -42,  94),
 S( -18,  66), S(-148, 207), S( -40, 160), S(-130, 183),
 S(   4,  52), S( -31, 142), S( -74, 129), S( -89, 125),
 S( -75,  20), S(  -2,  79), S(  43,  50), S( -65,  68),
 S( -34, -49), S(  -5,  20), S(   1,   2), S( -38,  14),
 S(  25, -84), S( -34,  25), S( -38, -15), S( -45, -14),
 S(  40,-210), S(  49,-114), S(  32,-118), S( -70,-101),
},{
 S(-124,-289), S(-462,  57), S( -29,-113), S( -29,-123),
 S(-412,  24), S(-192, 215), S(-289, 189), S( 344,  17),
 S(-178,  42), S(  75, 207), S( 316, 145), S( 106, 179),
 S(-139,  18), S(  28, 136), S(  50, 150), S(  11, 145),
 S(-143,  -4), S( -96,  89), S(  21,  73), S( -21,  93),
 S( -13, -34), S(  29,  42), S(   8,  31), S(  15,  38),
 S(  24, -33), S(  12,  54), S( -17,  24), S( -42,  19),
 S(  33,-136), S(  30, -36), S(   7, -61), S( -53, -67),
}};

const Score KNIGHT_POST_PSQT[12] = {
 S(-101,  23), S(   8,  44), S(  58,  57), S( 124,  91),
 S(  34,  -7), S(  79,  46), S(  59,  58), S(  79,  86),
 S(  42,   0), S(  73,  27), S(  46,  36), S(  38,  46),
};

const Score BISHOP_POST_PSQT[12] = {
 S(  -6,  17), S(  49,   4), S( 116,  27), S( 125,  12),
 S(   9,  -7), S(  50,  25), S(  88,   5), S( 105,  19),
 S(  -8,  36), S(  91,  17), S(  64,  25), S(  73,  47),
};

const Score KNIGHT_MOBILITIES[9] = {
 S(-256, -61), S(-171, 112), S(-134, 195), S(-109, 225),
 S( -90, 252), S( -75, 280), S( -58, 288), S( -42, 293),
 S( -27, 276),};

const Score BISHOP_MOBILITIES[14] = {
 S( -45, 132), S(   5, 196), S(  32, 244), S(  46, 289),
 S(  59, 308), S(  67, 330), S(  70, 347), S(  78, 355),
 S(  78, 365), S(  85, 368), S( 100, 361), S( 119, 356),
 S( 116, 371), S( 149, 336),};

const Score ROOK_MOBILITIES[15] = {
 S(-262, -90), S(-284, 371), S(-253, 446), S(-241, 449),
 S(-246, 490), S(-238, 505), S(-248, 522), S(-239, 522),
 S(-233, 535), S(-223, 545), S(-220, 557), S(-230, 574),
 S(-225, 581), S(-214, 592), S(-202, 583),};

const Score QUEEN_MOBILITIES[28] = {
 S(-2246,-2393), S(-150,-403), S( -41, 573), S(   1, 868),
 S(  25, 948), S(  37, 974), S(  38,1039), S(  42,1081),
 S(  48,1114), S(  55,1123), S(  61,1135), S(  68,1136),
 S(  68,1150), S(  77,1150), S(  77,1153), S(  92,1137),
 S(  89,1141), S(  85,1148), S(  98,1111), S( 136,1049),
 S( 165, 984), S( 185, 916), S( 247, 854), S( 295, 703),
 S( 269, 687), S( 287, 581), S(  18, 565), S( 777, -57),
};
...
const Score BISHOP_TRAPPED = S(-228, -547);

const Score ROOK_TRAPPED = S(-77, -57);
...
const Score ROOK_TO_OPEN = S(32, 41);
...
const Score CONNECTED_PAWN[4][8] = {
 { S(0, 0), S(117, 48), S(-4, 57), S(0, 20), S(2, 1), S(5, 0), S(6, -10), S(0, 0),},
 { S(0, 0), S(172, 62), S(40, 77), S(11, 26), S(19, 5), S(13, -4), S(1, 4), S(0, 0),},
 { S(0, 0), S(143, 143), S(48, 82), S(28, 29), S(13, 10), S(9, 4), S(-1, -11), S(0, 0),},
 { S(0, 0), S(101, 136), S(51, 87), S(19, 34), S(11, 15), S(8, 5), S(10, 3), S(0, 0),},
};

const Score CANDIDATE_PASSER[8] = {
 S(   0,   0), S(   0,   0), S( 401, 320), S(  16, 158),
 S( -32, 140), S( -46, 100), S( -59,  55), S(   0,   0),
};

const Score CANDIDATE_EDGE_DISTANCE = S(11, -33);

const Score PASSED_PAWN[8] = {
 S(   0,   0), S( 255, 454), S( 124, 407), S(  21, 247),
 S( -24, 166), S( -22,  88), S( -15,  76), S(   0,   0),
};

const Score PASSED_PAWN_EDGE_DISTANCE = S(3, -22);

const Score PASSED_PAWN_KING_PROXIMITY = S(-16, 51);

const Score PASSED_PAWN_ADVANCE_DEFENDED[5] = {
 S(   0,   0), S( 176, 556), S(  20, 294), S(  15, 102), S(  22,  23),
};

const Score PASSED_PAWN_ENEMY_SLIDER_BEHIND = S(57, -252);

const Score PASSED_PAWN_SQ_RULE = S(0, 813);

const Score PASSED_PAWN_UNSUPPORTED = S(-48, -10);

const Score PASSED_PAWN_OUTSIDE_V_KNIGHT = S(-32, 179);

const Score KNIGHT_THREATS[6] = { S(-1, 45), S(-5, 78), S(73, 82), S(177, 27), S(146, -105), S(0, 0),};

const Score BISHOP_THREATS[6] = { S(4, 44), S(47, 82), S(0, 0), S(147, 45), S(128, 66), S(223, 2961),};

const Score ROOK_THREATS[6] = { S(-1, 49), S(65, 94), S(70, 116), S(17, 43), S(104, -81), S(430, 2166),};
...
const Score PAWN_PUSH_THREAT_PINNED = S(109, 274);

const Score HANGING_THREAT = S(23, 45);

const Score KNIGHT_CHECK_QUEEN = S(27, 0);

const Score BISHOP_CHECK_QUEEN = S(46, 46);

const Score ROOK_CHECK_QUEEN = S(41, 12);

const Score SPACE = 226;

const Score IMBALANCE[5][5] = {
 { S(0, 0),},
 { S(18, 59), S(0, 0),},
 { S(11, 49), S(-6, -45), S(0, 0),},
 { S(10, 81), S(-52, -3), S(-15, 7), S(0, 0),},
 { S(99, 107), S(-113, 101), S(-59, 190), S(-488, 364), S(0, 0),},
};

const Score PAWN_SHELTER[4][8] = {
 { S(-41, -19), S(66, 189), S(-6, 99), S(-30, 4), S(21, -26), S(87, -76), S(73, -124), S(0, 0),},
 { S(-94, 12), S(-31, 168), S(-75, 119), S(-69, 56), S(-56, 24), S(53, -40), S(71, -67), S(0, 0),},
 { S(-63, 6), S(-19, 199), S(-108, 104), S(-49, 46), S(-43, 22), S(-21, 9), S(43, -21), S(0, 0),},
 { S(-81, 32), S(58, 126), S(-109, 56), S(-67, 57), S(-58, 44), S(-32, 19), S(-53, 39), S(0, 0),},
};

const Score PAWN_STORM[4][8] = {
 { S(-38, -21), S(-40, -4), S(-40, -14), S(-54, 12), S(-110, 71), S(141, 169), S(599, 176), S(0, 0),},
 { S(-18, 3), S(17, -11), S(17, -5), S(-19, 23), S(-49, 50), S(-36, 175), S(206, 285), S(0, 0),},
 { S(54, -7), S(57, -16), S(47, -6), S(24, 7), S(-15, 35), S(-93, 160), S(167, 193), S(0, 0),},
 { S(-3, -4), S(9, -27), S(32, -19), S(13, -24), S(-27, 7), S(-44, 107), S(-127, 279), S(0, 0),},
};

const Score BLOCKED_PAWN_STORM[8] = {
 S(-26, -86), S(81, -123), S(47, -75), S(43, -68), S(21, -56), S(16, -177), S(0, 0), S(0, 0),
};
