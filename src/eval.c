...
const Score PAWN_PSQT[2][32] = {{
 ...
 S(  75,  87), S(  79,  93), S(  76,  85), S(  83,  88),
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
},{
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
 S( 156, 152), S(  52, 158), S( 160, 149), S(  98, 195),
 S(  93,  82), S( 101,  74), S( 117,  49), S(  91,  67),
 S(  68,  79), S(  83,  73), S(  66,  65), S(  84,  67),
 S(  57,  72), S(  73,  77), S(  63,  70), S(  83,  73),
...
const Score KNIGHT_PSQT[2][32] = {{
 ...
 S( -58,  63), S( -64,  71), S( -67,  80), S( -76,  81),
 S( -68,  88), S( -65,  81), S( -49,  78), S( -63,  83),
 S( -70,  82), S( -62,  77), S( -50,  87), S( -56,  86),
 S( -91,  61), S( -82,  61), S( -73,  69), S( -75,  83),
 S(-102,  62), S( -86,  59), S( -83,  65), S( -77,  65),
 S(-125,  71), S( -89,  61), S( -89,  62), S( -80,  74),
},{
 S(-241, -96), S(-289,  50), S(-137,  34), S( -67,  59),
 S( -90,  15), S( -19,  38), S( -58,  68), S( -76,  72),
 S( -44,  33), S( -88,  50), S( -34,  29), S( -47,  62),
 S( -61,  66), S( -56,  61), S( -51,  68), S( -55,  78),
 S( -65,  78), S( -74,  70), S( -47,  80), S( -63,  94),
 S( -71,  56), S( -57,  53), S( -67,  61), S( -61,  79),
 S( -72,  57), S( -61,  56), S( -75,  58), S( -77,  62),
 S( -81,  66), S( -94,  63), S( -75,  57), S( -72,  71),
}};

const Score BISHOP_PSQT[2][32] = {{
 S( -21, 114), S( -41, 135), S( -28, 116), S( -43, 131),
 S(   2, 118), S( -15, 105), S(  25, 110), S(  10, 122),
 S(  19, 121), S(  20, 121), S( -11, 103), S(  24, 110),
 S(  12, 119), S(  36, 113), S(  26, 116), S(  17, 134),
 S(  32, 104), S(  23, 116), S(  30, 116), S(  40, 113),
 S(  27,  96), S(  44, 109), S(  29,  94), S(  32, 110),
 S(  30,  93), S(  29,  66), S(  43,  85), S(  27, 104),
 S(  23,  72), S(  41,  88), S(  29, 105), S(  34, 104),
},{
 S( -60,  77), S(  39, 100), S( -34, 107), S( -63, 111),
 S(   6,  74), S( -27, 104), S(  -8, 121), S(  23, 102),
 S(  40, 107), S(   8, 110), S(  10, 104), S(  23, 111),
 S(   8, 104), S(  36, 108), S(  38, 112), S(  36, 113),
 S(  48,  81), S(  38, 105), S(  42, 113), S(  34, 115),
 S(  40,  86), S(  56,  97), S(  37,  94), S(  33, 120),
 S(  42,  68), S(  41,  68), S(  43,  99), S(  35, 105),
 S(  41,  50), S(  31, 123), S(  24, 111), S(  42, 102),
}};

const Score ROOK_PSQT[2][32] = {{
 S( -98, 236), S( -89, 241), S( -89, 244), S(-116, 246),
 S( -89, 230), S( -94, 240), S( -76, 239), S( -60, 222),
 S(-102, 238), S( -67, 232), S( -77, 233), S( -76, 226),
 S( -96, 251), S( -81, 247), S( -67, 244), S( -64, 228),
 S(-100, 247), S( -92, 247), S( -87, 243), S( -79, 233),
 S(-104, 236), S( -93, 224), S( -87, 227), S( -85, 224),
 S(-100, 221), S( -95, 225), S( -83, 222), S( -79, 213),
 S(-103, 230), S( -95, 222), S( -94, 228), S( -86, 213),
},{
 S( -37, 221), S( -88, 246), S(-145, 256), S( -88, 237),
 S( -66, 210), S( -54, 223), S( -75, 227), S( -89, 228),
 S( -92, 215), S( -36, 210), S( -63, 203), S( -43, 204),
 S( -86, 222), S( -51, 218), S( -58, 207), S( -55, 218),
 S(-104, 220), S( -83, 221), S( -84, 216), S( -69, 222),
 S( -93, 195), S( -73, 195), S( -79, 199), S( -74, 210),
 S( -87, 197), S( -65, 185), S( -77, 193), S( -74, 203),
 S(-100, 210), S( -79, 203), S( -86, 204), S( -78, 203),
}};

const Score QUEEN_PSQT[2][32] = {{
 S(-112, 401), S( -34, 306), S(   1, 308), S(  -9, 333),
 S( -45, 343), S( -37, 318), S( -22, 342), S( -29, 344),
 S( -15, 317), S( -10, 306), S( -20, 340), S(  -2, 333),
 S( -10, 335), S(  -7, 351), S(  -5, 351), S( -24, 365),
 S(   4, 304), S( -16, 358), S( -13, 349), S( -19, 371),
 S(  -2, 287), S(  -2, 306), S(  -7, 325), S( -11, 325),
 S(   3, 257), S(   0, 268), S(   6, 269), S(   4, 283),
 S(  -8, 277), S( -10, 272), S(  -7, 276), S(  -4, 279),
},{
 S(  36, 288), S(  91, 267), S(-107, 395), S(   4, 297),
 S(  26, 282), S(   5, 274), S( -15, 328), S( -35, 355),
 S(  24, 279), S(  -1, 273), S(  17, 296), S(  -9, 335),
 S(  -1, 309), S(   5, 317), S(  22, 285), S( -16, 358),
 S(   9, 281), S(   3, 308), S(   8, 312), S( -14, 364),
 S(   6, 248), S(  10, 275), S(  12, 298), S(  -5, 322),
 S(  27, 210), S(  24, 210), S(  17, 238), S(  10, 279),
 S(  20, 242), S( -11, 260), S(  -6, 244), S(   0, 261),
}};

const Score KING_PSQT[2][32] = {{
 S( 226,-134), S( 135, -58), S( -20, -15), S( 103, -41),
 S( -97,  57), S( -32,  70), S(   0,  55), S(  37,  23),
 S(  13,  43), S(  -3,  75), S(  28,  64), S( -10,  67),
 S(  19,  39), S(  12,  61), S(  -9,  61), S( -20,  53),
 S( -26,  24), S(  19,  38), S(  33,  30), S( -29,  34),
 S( -26,  -2), S(   1,  13), S(  -2,  11), S( -13,   5),
 S(   5, -23), S( -22,  11), S( -24,  -4), S( -29, -13),
 S(  12, -82), S(  17, -38), S(   7, -37), S( -48, -35),
},{
 S( -24,-136), S(-295,  55), S(   7, -35), S( -43, -35),
 S(-210,  16), S( -90,  87), S( -74,  69), S( 146,  14),
 S(-115,  29), S(  42,  86), S( 146,  70), S(  85,  60),
 S( -93,  17), S(  15,  57), S(   4,  72), S(   6,  57),
 S( -78,   3), S( -48,  38), S(   6,  36), S(  -7,  35),
 S(  -4, -15), S(  24,  10), S(   8,  11), S(  15,   7),
 S(  13, -15), S(   9,  10), S(  -5,  -1), S( -19, -10),
...
const Score KNIGHT_MOBILITIES[9] = {
 S(-160, -30), S(-117,  44), S( -99,  83), S( -87,  97),
 S( -78, 110), S( -70, 122), S( -61, 125), S( -52, 126),
 S( -44, 117),};

const Score BISHOP_MOBILITIES[14] = {
 S( -11,  52), S(  13,  79), S(  26, 101), S(  32, 122),
 S(  39, 131), S(  43, 141), S(  45, 148), S(  49, 151),
 S(  50, 154), S(  53, 155), S(  61, 151), S(  74, 146),
 S(  74, 152), S(  85, 138),};

const Score ROOK_MOBILITIES[15] = {
 S( -84, -65), S( -98, 150), S( -82, 185), S( -75, 190),
 S( -78, 213), S( -73, 221), S( -78, 231), S( -74, 232),
 S( -70, 239), S( -65, 243), S( -62, 246), S( -64, 251),
 S( -60, 253), S( -52, 258), S( -38, 250),};

const Score QUEEN_MOBILITIES[28] = {
 S(-1864,-1379), S(-130,-316), S( -76, 132), S( -52, 259),
 S( -41, 300), S( -35, 311), S( -36, 344), S( -36, 368),
 S( -34, 387), S( -31, 392), S( -29, 399), S( -26, 400),
 S( -27, 407), S( -24, 406), S( -26, 410), S( -20, 401),
 S( -23, 402), S( -26, 403), S( -19, 382), S(  -3, 353),
 S(  14, 318), S(  28, 278), S(  65, 243), S( 108, 153),
 S(  72, 163), S( 202,  30), S(  31,  43), S(  60,  -9),
};
...
const Score ROOK_OPEN_FILE = S(30, 15);
...
const Score PASSED_PAWN_ADVANCE_DEFENDED[5] = {
 S(   0,   0), S(  88, 261), S(  16, 138), S(   8,  47), S(  12,  10),
};
...
const Score IMBALANCE[5][5] = {
 ...
 { S(56, 48), S(-68, 15), S(-12, 81), S(-208, 157), S(0, 0),},
};

const Score PAWN_SHELTER[4][8] = {
 { S(-21, -4), S(15, 95), S(-3, 50), S(-14, 7), S(8, -5), S(37, -26), S(34, -49), S(0, 0),},
 { S(-44, 1), S(-9, 74), S(-22, 44), S(-31, 20), S(-27, 7), S(24, -18), S(32, -33), S(0, 0),},
 { S(-22, -12), S(-2, 87), S(-37, 34), S(-13, 6), S(-14, -4), S(-3, -9), S(29, -21), S(0, 0),},
 { S(-39, 17), S(12, 75), S(-61, 35), S(-31, 29), S(-29, 22), S(-17, 13), S(-26, 22), S(0, 0),},
};

const Score PAWN_STORM[4][8] = {
 { S(-21, -12), S(-23, -3), S(-24, -8), S(-28, 4), S(-56, 30), S(57, 81), S(274, 73), S(0, 0),},
 { S(-13, -1), S(3, -7), S(3, -5), S(-12, 9), S(-27, 21), S(-31, 83), S(93, 130), S(0, 0),},
 { S(25, -4), S(27, -8), S(24, -5), S(7, 4), S(-15, 18), S(-48, 76), S(61, 95), S(0, 0),},
 { S(-3, -4), S(3, -12), S(15, -10), S(4, -12), S(-18, 4), S(-17, 47), S(-35, 120), S(0, 0),},
};

const Score BLOCKED_PAWN_STORM[8] = {
 S(0, -44), S(37, -51), S(19, -37), S(16, -31), S(4, -24), S(5, -84), S(0, 0), S(0, 0),
};
