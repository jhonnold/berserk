...
Score PHASE_MULTIPLIERS[5] = {0, 4, 7, 11, 15};

Score MATERIAL_VALUES[7][2] = {
    {100, 150}, {592, 425}, {614, 407}, {783, 775}, {1577, 1470}, {30000, 30000}, {0, 0},
};
...
Score PAWN_PSQT[32][2] = {
  {   0,   0}, {   0,   0}, {   0,   0}, {   0,   0}, 
  {   4,  34}, {   9,  27}, {   0,  13}, {  -1,  -2}, 
  {   5,  31}, {  13,  26}, {  26,  -2}, {  -4, -30}, 
  {  -9,  15}, {   9,  -2}, {  19, -20}, {  28, -31}, 
  { -25,  -2}, { -17, -10}, {   2, -24}, {   9, -25}, 
  { -22, -11}, {  -9, -13}, {  -3, -17}, {  -4, -11}, 
  { -25,  -9}, {  17, -13}, {   5,  -5}, {  -7,   0}, 
  {   0,   0}, {   0,   0}, {   0,   0}, {   0,   0}, 
};

Score KNIGHT_PSQT[32][2] = {
  { -96, -62}, { -35, -52}, { -37, -26}, {  -8, -30}, 
  { -41, -41}, { -30,  -8}, {  31, -22}, {   8,   1}, 
  { -26, -39}, {   8, -23}, {  11,  11}, {  19,   9}, 
  {  13, -13}, {  16,  -4}, {  12,  18}, {  20,  24}, 
  {   1,  -8}, {  20,  -9}, {  16,  16}, {  17,  20}, 
  { -23, -13}, {  -2, -16}, {  -1,  -5}, {   8,  18}, 
  { -14, -30}, { -22, -12}, {  -6, -10}, {   5,   2}, 
  { -38, -24}, { -10, -26}, { -31,  -8}, {  -4,  -4},
};
...
Score QUEEN_PSQT[32][2] = {
  {   6, -16}, {  15,  -6}, {  14,  -2}, {  18,   4}, 
  { -13, -33}, { -39, -33}, { -19, -10}, { -23,   7}, 
  {   0, -22}, {  -8, -17}, {   6,  -7}, {  -6,  25}, 
  { -23,  16}, { -27,  26}, { -23,  14}, { -29,  25}, 
  { -11,  -3}, { -23,  23}, { -20,  26}, { -26,  37}, 
  { -17,  -2}, {   4, -13}, { -14,  19}, { -11,  14}, 
  { -18, -28}, { -13, -31}, {  18, -32}, {   6,  -7}, 
  { -15, -38}, { -19, -33}, { -15, -27}, {  13, -36}, 
};

Score KING_PSQT[32][2] = {
  { -43, -71}, { -22, -42}, { -38, -21}, { -67, -33}, 
  { -23, -28}, {  -4,  -4}, { -21,  13}, { -40,  12}, 
  {  -8, -19}, {  13,  10}, {  -2,  23}, { -31,   6}, 
  { -20, -33}, {  14,  -2}, {  -2,  17}, { -23,  19}, 
  { -29, -46}, {  -8, -19}, { -22,  12}, { -46,  24}, 
  { -12, -39}, {  12, -16}, { -15,   6}, { -32,  18}, 
  {  31, -52}, {  45, -32}, {  -8,  -3}, { -33,   6}, 
  {  14, -96}, {  62, -65}, {  24, -39}, {  22, -48}, 
};

// clang-format on

Score KNIGHT_MOBILITIES[9][2] = {
    {-67, -95}, {-44, -75}, {-26, -39}, {-22, -15}, {-2, -11}, {9, 0}, {20, -2}, {31, -2}, {42, -11},
};

Score BISHOP_MOBILITIES[14][2] = {
    {-58, -60}, {-40, -57}, {-18, -20}, {-12, 7}, {-2, 22}, {12, 30}, {19, 39},
    {24, 45},   {30, 53},   {32, 54},   {49, 48}, {67, 54}, {39, 76}, {52, 63},
};

Score ROOK_MOBILITIES[15][2] = {
    {-3, -63}, {-29, -67}, {-19, -41}, {-17, -31}, {-19, -3}, {-20, 17}, {-16, 26}, {-15, 28},
    {-7, 29},  {4, 33},    {13, 36},   {25, 40},   {31, 46},  {38, 49},  {36, 51},
};

Score QUEEN_MOBILITIES[28][2] = {{-10, -75}, {-12, -52}, {-14, -36}, {-26, -20}, {-19, -14}, {-13, -16}, {-13, -18},
                                 {-2, -6},   {4, -4},    {9, -5},    {10, 18},   {10, 30},   {18, 23},   {12, 54},
                                 {15, 58},   {16, 61},   {13, 66},   {13, 68},   {16, 67},   {39, 75},   {30, 65},
                                 {33, 79},   {31, 60},   {19, 61},   {14, 53},   {4, 71},    {3, 55},    {2, 54}};

Score BISHOP_PAIR[2] = {44, 73};
Score DOUBLED_PAWN[2] = {-3, -38};
Score OPPOSED_ISOLATED_PAWN[2] = {-12, 0};
Score OPEN_ISOLATED_PAWN[2] = {-18, -11};
Score BACKWARDS_PAWN[2] = {-8, -10};
Score DEFENDED_PAWN[2] = {16, 0};
Score CONNECTED_PAWN[8][2] = {
    {0, 0}, {44, 57}, {30, 23}, {13, 8}, {10, 2}, {7, -1}, {4, -3}, {0, 0},
};

Score PASSED_PAWN[8][2] = {
    {0, 0}, {236, 240}, {98, 166}, {29, 76}, {5, 41}, {10, 8}, {12, 2}, {0, 0},
};

Score DEFENDED_MINOR[2] = {5, 10};

Score ROOK_OPEN_FILE[2] = {49, -2};
Score ROOK_SEMI_OPEN[2] = {12, 8};
Score ROOK_SEVENTH_RANK[2] = {11, 23};
Score ROOK_OPPOSITE_KING[2] = {36, -1};
Score ROOK_ADJACENT_KING[2] = {11, -20}; // interesting EG value

Score ROOK_TRAPPED[2] = {-67, -41};
Score BISHOP_TRAPPED[2] = {-155, -147};

Score KNIGHT_THREATS[6][2] = {{-13, 20}, {-5, 9}, {37, 17}, {33, 17}, {28, 27}, {87, 30}};
Score BISHOP_THREATS[6][2] = {{-7, 17}, {25, 41}, {6, 9}, {21, 18}, {31, 39}, {82, 78}};
Score ROOK_THREATS[6][2] = {{-6, 20}, {29, 21}, {39, 34}, {16, 12}, {54, 17}, {88, 39}};
Score KING_THREATS[6][2] = {{28, 80}, {-8, 31}, {-2, 34}, {-15, 29}, {-23, 27}, {15, 60}};
Score HANGING_THREAT[2] = {14, -7}; // what is that eg value??

Score PAWN_SHELTER[2][8][2] = {
    {{-48, 1}, {-27, -20}, {-27, -13}, {-21, -51}, {-15, -35}, {-14, 0}, {2, 25}, {0, 0}},
    {{-71, -39}, {-74, -65}, {-64, -50}, {-45, -65}, {-34, -33}, {-17, -16}, {-10, -10}, {0, 0}},
};
Score PAWN_STORM[8][2] = {{0, 0}, {0, 0}, {13, -14}, {-3, 8}, {-15, 0}, {-69, -57}, {16, 24}, {0, 0}};

Score KS_ATTACKER_WEIGHTS[5] = {0, 64, 54, 67, 26};
Score KS_ATTACK = 38;
Score KS_WEAK_SQS = 74;
Score KS_SAFE_CHECK = 90;
Score KS_UNSAFE_CHECK = 12;
Score KS_ENEMY_QUEEN = -246;
Score KS_ALLIES = -16;
...
inline Score getPhase(Board* board) {
  Score currentPhase = 0;
  for (int i = 2; i < 10; i++)
    currentPhase += PHASE_MULTIPLIERS[PIECE_TYPE[i]] * bits(board->pieces[i]);
...
inline Score taper(Score mg, Score eg, Score phase) {
  ...
  return (mg * phase + (eg * (max - phase))) / max;
}
