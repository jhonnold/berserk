...
const Score PAWN_PSQT[2][32] = {{
 ...
 S( 120, 199), S( 117, 223), S(  84, 220), S( 115, 194),
 S(  82, 135), S(  63, 154), S(  82, 100), S(  86,  80),
 S(  80, 117), S(  80, 103), S(  67,  86), S(  62,  79),
 S(  75,  92), S(  72,  94), S(  67,  81), S(  75,  81),
 S(  67,  83), S(  69,  86), S(  68,  81), S(  70,  90),
 S(  75,  87), S(  82,  93), S(  81,  85), S(  87,  87),
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
},{
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
 S( 159, 153), S(  67, 157), S( 164, 150), S( 102, 197),
 S(  96,  82), S( 105,  74), S( 120,  49), S(  94,  67),
 S(  70,  79), S(  86,  74), S(  70,  65), S(  86,  68),
 S(  59,  72), S(  76,  77), S(  68,  69), S(  86,  73),
 S(  41,  71), S(  73,  72), S(  71,  75), S(  80,  85),
 S(  49,  81), S(  89,  83), S(  80,  83), S(  88,  98),
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
}};

const Score KNIGHT_PSQT[2][32] = {{
 S(-188,  54), S(-197,  76), S(-168,  85), S(-129,  65),
 S(-117,  83), S( -98,  86), S( -73,  69), S( -69,  70),
 S( -59,  64), S( -66,  71), S( -69,  80), S( -81,  82),
 S( -70,  89), S( -65,  81), S( -53,  79), S( -64,  83),
 S( -70,  82), S( -64,  77), S( -50,  86), S( -58,  86),
 S( -91,  61), S( -81,  59), S( -71,  67), S( -74,  83),
 S(-102,  62), S( -85,  58), S( -81,  65), S( -75,  63),
 S(-124,  71), S( -87,  62), S( -87,  62), S( -78,  74),
},{
 S(-240, -96), S(-275,  48), S(-140,  34), S( -70,  60),
 S( -92,  16), S( -22,  39), S( -60,  68), S( -75,  71),
 S( -46,  33), S( -87,  49), S( -34,  29), S( -50,  62),
 S( -60,  65), S( -57,  61), S( -50,  67), S( -59,  79),
 S( -65,  78), S( -73,  69), S( -47,  80), S( -64,  94),
 S( -71,  56), S( -56,  52), S( -65,  60), S( -60,  78),
 S( -71,  57), S( -60,  56), S( -74,  58), S( -75,  61),
 S( -81,  66), S( -93,  65), S( -75,  57), S( -69,  70),
}};

const Score BISHOP_PSQT[2][32] = {{
 S( -19, 113), S( -42, 134), S( -32, 116), S( -45, 130),
 S(  -2, 118), S( -16, 103), S(  23, 109), S(   8, 121),
 S(  16, 121), S(  18, 120), S( -12, 102), S(  19, 110),
 S(  10, 119), S(  34, 112), S(  22, 116), S(  15, 132),
 S(  31, 102), S(  19, 115), S(  29, 114), S(  38, 112),
 S(  24,  95), S(  43, 108), S(  28,  92), S(  32, 108),
 S(  29,  92), S(  28,  65), S(  43,  83), S(  25, 103),
 S(  21,  72), S(  42,  87), S(  29, 107), S(  34, 103),
},{
 S( -59,  75), S(  45,  98), S( -40, 107), S( -65, 110),
 S(   4,  73), S( -32, 103), S(  -8, 119), S(  20, 101),
 S(  35, 107), S(   6, 109), S(   8, 103), S(  20, 111),
 S(   7, 103), S(  36, 106), S(  38, 110), S(  34, 111),
 S(  45,  81), S(  38, 103), S(  40, 112), S(  34, 113),
 S(  39,  85), S(  54,  96), S(  37,  93), S(  31, 119),
 S(  41,  67), S(  41,  67), S(  41,  98), S(  35, 103),
 S(  40,  49), S(  30, 123), S(  24, 112), S(  41, 101),
}};

const Score ROOK_PSQT[2][32] = {{
 S(-106, 228), S( -98, 233), S( -96, 236), S(-126, 238),
 S( -93, 221), S( -98, 231), S( -82, 229), S( -66, 213),
 S(-109, 230), S( -75, 223), S( -86, 225), S( -85, 219),
 S(-103, 244), S( -88, 239), S( -76, 236), S( -73, 220),
 S(-104, 238), S( -99, 238), S( -94, 235), S( -87, 225),
 S(-108, 228), S( -98, 215), S( -93, 218), S( -93, 216),
 S(-103, 212), S( -99, 216), S( -86, 212), S( -83, 204),
 S(-105, 220), S( -98, 212), S( -95, 217), S( -88, 204),
},{
 S( -40, 211), S( -94, 237), S(-155, 249), S( -97, 229),
 S( -74, 203), S( -59, 214), S( -81, 218), S( -94, 219),
 S( -96, 207), S( -44, 202), S( -70, 194), S( -51, 195),
 S( -90, 215), S( -56, 210), S( -65, 199), S( -64, 209),
 S(-107, 212), S( -87, 213), S( -89, 207), S( -76, 213),
 S( -96, 187), S( -78, 187), S( -83, 190), S( -80, 202),
 S( -90, 188), S( -67, 176), S( -81, 184), S( -77, 194),
 S(-102, 200), S( -81, 194), S( -88, 194), S( -79, 193),
}};

const Score QUEEN_PSQT[2][32] = {{
 S(-105, 394), S( -25, 300), S(  15, 299), S(   8, 321),
 S( -28, 330), S(  -3, 291), S(   8, 321), S(   5, 320),
 S(   2, 303), S(  11, 291), S(   7, 319), S(  23, 317),
 S(  -4, 329), S(   4, 342), S(   9, 340), S(   0, 344),
 S(   4, 305), S(  -9, 352), S(  -4, 341), S( -11, 361),
 S(  -4, 289), S(  -1, 305), S(  -4, 321), S(  -8, 322),
 S(   0, 257), S(  -2, 270), S(   4, 271), S(   3, 285),
 S( -14, 279), S( -14, 274), S( -12, 279), S(  -9, 285),
},{
 S(  45, 282), S( 108, 257), S( -86, 383), S(  25, 283),
 S(  33, 275), S(  24, 262), S(  18, 305), S(   2, 329),
 S(  34, 270), S(  18, 259), S(  37, 284), S(  24, 313),
 S(   1, 310), S(  13, 313), S(  31, 281), S(  10, 338),
 S(  10, 281), S(   8, 307), S(  14, 308), S(  -6, 356),
 S(   5, 250), S(  12, 274), S(  12, 299), S(  -2, 321),
 S(  23, 214), S(  21, 217), S(  15, 242), S(   8, 282),
 S(  13, 245), S( -17, 265), S( -11, 251), S(  -4, 266),
}};

const Score KING_PSQT[2][32] = {{
 S( 228,-134), S( 126, -57), S( -23, -14), S( 111, -43),
 S( -97,  57), S( -33,  70), S(  -9,  57), S(  33,  24),
 S(  11,  43), S(  -4,  74), S(  26,  64), S( -12,  67),
 S(  13,  40), S(  12,  60), S( -11,  61), S( -24,  53),
 S( -28,  25), S(  18,  38), S(  33,  31), S( -30,  34),
 S( -25,  -2), S(   2,  14), S(  -2,  11), S( -14,   5),
 S(   6, -22), S( -20,  12), S( -24,  -4), S( -30, -13),
 S(  13, -81), S(  18, -38), S(   6, -37), S( -46, -35),
},{
 S( -30,-135), S(-299,  56), S(   9, -35), S( -48, -34),
 S(-213,  16), S( -95,  88), S( -76,  70), S( 145,  14),
 S(-114,  29), S(  41,  86), S( 145,  71), S(  78,  61),
 S( -95,  17), S(  16,  57), S(   2,  72), S(   3,  56),
 S( -80,   3), S( -48,  37), S(   5,  36), S( -10,  35),
 S(  -4, -15), S(  24,  11), S(   7,  12), S(  12,   7),
 S(  14, -15), S(   9,  11), S(  -6,   0), S( -22, -10),
 S(  16, -63), S(  17, -16), S(   3, -24), S( -31, -34),
}};

const Score KNIGHT_POST_PSQT[12] = {
 S( -48,   9), S(   6,  19), S(  28,  24), S(  61,  36),
 S(  13,  -4), S(  38,  19), S(  29,  27), S(  41,  35),
...
const Score KNIGHT_MOBILITIES[9] = {
 S(-157, -32), S(-116,  42), S( -98,  81), S( -85,  95),
 S( -77, 108), S( -70, 121), S( -62, 124), S( -55, 126),
 S( -46, 116),};

const Score BISHOP_MOBILITIES[14] = {
 S(  -9,  49), S(  14,  78), S(  27,  99), S(  33, 121),
 S(  39, 130), S(  43, 141), S(  44, 148), S(  48, 151),
 S(  48, 154), S(  51, 155), S(  58, 152), S(  70, 147),
 S(  70, 153), S(  82, 139),};

const Score ROOK_MOBILITIES[15] = {
 S( -85, -65), S( -96, 151), S( -81, 184), S( -76, 185),
 S( -79, 205), S( -75, 211), S( -80, 219), S( -76, 219),
 S( -73, 225), S( -68, 229), S( -66, 234), S( -70, 239),
 S( -67, 242), S( -61, 247), S( -49, 240),};

const Score QUEEN_MOBILITIES[28] = {
 S(-1879,-1383), S(-129,-330), S( -76, 131), S( -54, 263),
 S( -42, 302), S( -36, 314), S( -36, 346), S( -35, 368),
 S( -32, 385), S( -29, 389), S( -26, 395), S( -22, 395),
 S( -22, 401), S( -18, 400), S( -18, 401), S( -11, 392),
 S( -12, 392), S( -13, 392), S(  -5, 371), S(  13, 342),
 S(  30, 308), S(  44, 270), S(  81, 234), S( 124, 146),
 S(  93, 153), S( 219,  23), S(  42,  40), S(  64,  -5),
};
...
const Score BISHOP_TRAPPED = S(-117, -244);
...
const Score QUEEN_ROOK_BATTERY = S(4, 52);
...
const Score CONNECTED_PAWN[8] = {
 S(   0,   0), S(  80,  45), S(  24,  37), S(   9,  12),
 S(   6,   3), S(   5,   2), S(   2,  -1), S(   0,   0),
};

const Score CANDIDATE_PASSER[8] = {
 S(   0,   0), S(   0,   0), S( 188, 160), S(  16,  77),
...
const Score PASSED_PAWN[8] = {
 S(   0,   0), S( 125, 188), S(  48, 186), S(  16, 116),
...
const Score PASSED_PAWN_ADVANCE_DEFENDED[5] = {
 S(   0,   0), S(  86, 261), S(  14, 139), S(   6,  48), S(  11,  10),
};
...
const Score KNIGHT_THREATS[6] = { S(0, 20), S(-4, 48), S(35, 37), S(85, 10), S(69, -47), S(0, 0),};

const Score BISHOP_THREATS[6] = { S(2, 20), S(22, 37), S(-66, 81), S(71, 21), S(60, 40), S(366, 431),};

const Score ROOK_THREATS[6] = { S(-1, 23), S(31, 44), S(33, 55), S(8, 22), S(45, -26), S(436, 466),};
...
const Score PAWN_PUSH_THREAT_PINNED = S(51, 54);
...
const Score IMBALANCE[5][5] = {
 ...
 { S(54, 49), S(-68, 17), S(-12, 84), S(-203, 165), S(0, 0),},
};

const Score PAWN_SHELTER[4][8] = {
 { S(-21, -3), S(36, 91), S(-3, 51), S(-15, 7), S(7, -5), S(37, -26), S(34, -49), S(0, 0),},
 { S(-44, 1), S(-1, 72), S(-21, 44), S(-31, 19), S(-27, 7), S(24, -19), S(32, -33), S(0, 0),},
 { S(-23, -12), S(10, 84), S(-38, 34), S(-14, 7), S(-15, -4), S(-5, -9), S(28, -20), S(0, 0),},
 { S(-37, 17), S(32, 71), S(-59, 35), S(-30, 29), S(-28, 22), S(-16, 14), S(-25, 23), S(0, 0),},
};

const Score PAWN_STORM[4][8] = {
 { S(-19, -13), S(-24, -3), S(-24, -8), S(-28, 3), S(-57, 30), S(57, 80), S(271, 75), S(0, 0),},
 { S(-12, -1), S(3, -7), S(3, -5), S(-11, 8), S(-27, 20), S(-33, 83), S(94, 131), S(0, 0),},
 { S(24, -4), S(25, -8), S(23, -5), S(7, 4), S(-15, 18), S(-50, 76), S(59, 97), S(0, 0),},
 { S(-2, -5), S(2, -12), S(14, -10), S(3, -12), S(-19, 5), S(-21, 48), S(-37, 121), S(0, 0),},
};

const Score BLOCKED_PAWN_STORM[8] = {
 S(-17, -41), S(37, -52), S(19, -37), S(16, -31), S(5, -25), S(6, -84), S(0, 0), S(0, 0),
};
