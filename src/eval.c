...
Score PAWN_PSQT[32][2] = {
  {   0,   0}, {   0,   0}, {   0,   0}, {   0,   0}, 
  {  -9,  29}, {   1,  27}, {  27,  14}, {  49, -15},
  { -50,  32}, { -41,  29}, {  -9,   5}, {  -4, -25},
  { -59,  11}, { -51,   2}, { -41,  -7}, { -31, -13},
  { -59,  -4}, { -57,  -3}, { -44,  -8}, { -37,  -6},
  { -54,  -7}, { -43,  -8}, { -42,  -6}, { -36,  -3},
  { -59,  -3}, { -40,  -2}, { -41,   3}, { -39,   9}, 
  {   0,   0}, {   0,   0}, {   0,   0}, {   0,   0}, 
...
Score KNIGHT_PSQT[32][2] = {
  {-128, -34}, {-145,   2}, {-179,  14}, {-182,  31},
  { -52,  -3}, { -45,  17}, {  -5,  13}, { -35,  27},
  { -27,   0}, { -28,  16}, { -29,  28}, { -18,  21},
  {  -1,  14}, { -19,  16}, {   2,  17}, {   1,  21},
  {  -5,  20}, {   8,  10}, {   0,  22}, {   3,  27},
  { -25,  11}, { -14,  14}, { -14,  22}, {  -6,  29},
  { -14,  30}, { -16,  14}, { -19,  14}, {  -9,  18},
  { -23,  16}, { -20,  15}, { -12,  11}, { -10,  19},
};
...
Score BISHOP_PSQT[32][2] = {
  {-106,  16}, {-102,  21}, {-151,  26}, {-179,  31},
  { -50,   5}, { -65,  11}, { -48,  11}, { -74,  22},
  { -38,  12}, { -36,  15}, { -63,  27}, { -36,  10},
  { -59,  21}, { -34,  18}, { -41,  19}, { -22,  19},
  { -28,   5}, { -48,  15}, { -34,  19}, { -26,  17},
  { -37,   7}, { -19,  15}, { -29,  17}, { -28,  25},
  { -24,   6}, { -20,   7}, { -23,   4}, { -33,  17},
  { -22,   2}, { -22,   7}, { -29,  15}, { -33,  14}, 
};

Score ROOK_PSQT[32][2] = {
  { -31,  33}, { -54,  42}, { -66,  53}, { -72,  52},
  { -41,   4}, { -64,  21}, { -49,  21}, { -42,  15},
  { -39,  21}, { -13,  20}, { -18,  25}, { -13,  16},
  { -44,  28}, { -40,  27}, { -28,  25}, { -31,  25},
  { -54,  27}, { -48,  23}, { -57,  34}, { -46,  31},
  { -52,  19}, { -47,  17}, { -44,  24}, { -44,  24},
  { -47,  22}, { -48,  21}, { -41,  22}, { -34,  23},
  { -39,  24}, { -43,  21}, { -38,  26}, { -35,  21}, 
};

Score QUEEN_PSQT[32][2] = {
  { -88,  11}, { -89,  11}, { -73,  29}, { -95,  43},
  {-113,  19}, {-149,  61}, {-156,  88}, {-150,  84},
  {-123,  28}, {-132,  56}, {-120,  73}, {-116,  68},
  {-120,  50}, {-110,  63}, {-121,  68}, {-123,  92},
  {-108,  55}, {-113,  66}, {-115,  68}, {-116,  86},
  {-108,  32}, {-102,  47}, {-111,  66}, {-113,  70},
  { -99,   7}, {-100,  15}, {-100,  32}, {-101,  48},
  { -92, -13}, {-114,  28}, {-115,  28}, {-107,  29},
};
...
Score KNIGHT_MOBILITIES[9][2] = {{-111, -90}, {-80, -46}, {-64, -20}, {-56, -8}, {-47, 0},
                                 {-40, 5},    {-33, 5},   {-24, 3},   {-18, -4}};

Score BISHOP_MOBILITIES[14][2] = {{-60, -35}, {-39, -27}, {-25, -19}, {-18, -4}, {-8, 5},  {-2, 12}, {1, 17},
                                  {2, 21},    {5, 24},    {4, 27},    {8, 24},   {28, 20}, {32, 18}, {45, 19}};

Score ROOK_MOBILITIES[15][2] = {{-164, -179}, {-141, -26}, {-131, -13}, {-126, -18}, {-125, -3},
                                {-127, 5},    {-130, 15},  {-129, 12},  {-123, 12},  {-120, 16},
                                {-116, 17},   {-115, 17},  {-114, 21},  {-109, 19},  {-102, 17}};

Score QUEEN_MOBILITIES[28][2] = {{-126, -7},  {-200, -82}, {-200, -152}, {-200, -118}, {-200, -66}, {-200, -56},
                                 {-200, -27}, {-200, -7},  {-200, 13},   {-197, 13},   {-194, 16},  {-193, 19},
                                 {-194, 25},  {-192, 26},  {-192, 29},   {-191, 26},   {-197, 33},  {-195, 32},
                                 {-200, 32},  {-195, 18},  {-192, 14},   {-197, 20},   {-190, -2},  {-200, -7},
                                 {-200, -40}, {-83, -102}, {-63, -129},  {-74, -67}};
