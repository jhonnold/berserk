...
const Score PAWN_PSQT[2][32] = {{
 ...
 S(  79, 116), S(  77, 103), S(  65,  86), S(  60,  78),
 S(  74,  91), S(  69,  94), S(  65,  80), S(  72,  81),
 S(  67,  82), S(  65,  86), S(  64,  81), S(  67,  90),
 S(  75,  86), S(  79,  93), S(  77,  85), S(  83,  88),
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
},{
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
...
const Score KNIGHT_PSQT[2][32] = {{
 S(-188,  54), S(-193,  75), S(-163,  84), S(-122,  64),
 S(-113,  81), S( -96,  86), S( -71,  69), S( -68,  70),
 S( -58,  63), S( -64,  71), S( -67,  81), S( -75,  81),
 ...
 S(-241, -96), S(-289,  51), S(-136,  34), S( -67,  60),
 S( -89,  16), S( -18,  38), S( -58,  68), S( -75,  72),
 S( -44,  33), S( -87,  50), S( -34,  29), S( -47,  62),
 S( -61,  66), S( -55,  61), S( -51,  69), S( -55,  78),
...
const Score BISHOP_PSQT[2][32] = {{
 S( -22, 114), S( -41, 135), S( -28, 116), S( -44, 131),
 S(   1, 118), S( -15, 104), S(  24, 110), S(   9, 122),
 S(  18, 121), S(  20, 121), S( -11, 103), S(  23, 110),
 S(  12, 119), S(  35, 113), S(  26, 116), S(  17, 134),
 S(  31, 104), S(  22, 116), S(  29, 116), S(  39, 113),
 S(  26,  96), S(  43, 109), S(  28,  94), S(  31, 110),
 S(  29,  93), S(  29,  66), S(  42,  85), S(  26, 104),
 S(  22,  72), S(  41,  88), S(  29, 105), S(  33, 104),
},{
 S( -61,  77), S(  39, 100), S( -35, 106), S( -63, 111),
 S(   5,  74), S( -27, 103), S(  -8, 121), S(  22, 102),
 S(  39, 107), S(   8, 109), S(  10, 104), S(  22, 111),
...
const Score ROOK_PSQT[2][32] = {{
 S( -97, 237), S( -88, 241), S( -88, 245), S(-115, 247),
 S( -88, 231), S( -93, 241), S( -76, 239), S( -59, 223),
 S(-101, 239), S( -66, 232), S( -77, 234), S( -75, 227),
 S( -96, 252), S( -80, 248), S( -66, 245), S( -63, 228),
 S( -99, 247), S( -91, 247), S( -86, 244), S( -78, 233),
 S(-103, 237), S( -92, 224), S( -86, 227), S( -85, 224),
 S(-100, 221), S( -94, 226), S( -82, 223), S( -78, 214),
 S(-102, 230), S( -94, 222), S( -93, 228), S( -85, 214),
},{
 S( -36, 222), S( -88, 247), S(-144, 257), S( -87, 237),
 S( -66, 211), S( -54, 223), S( -74, 227), S( -88, 229),
 S( -91, 216), S( -36, 210), S( -62, 203), S( -43, 205),
 S( -85, 223), S( -50, 219), S( -58, 208), S( -55, 218),
 S(-103, 221), S( -82, 222), S( -83, 217), S( -69, 222),
 S( -92, 195), S( -73, 195), S( -78, 200), S( -73, 211),
 S( -86, 197), S( -64, 186), S( -76, 194), S( -73, 204),
 S(-100, 211), S( -78, 204), S( -85, 204), S( -77, 204),
}};

const Score QUEEN_PSQT[2][32] = {{
 S(-112, 402), S( -33, 307), S(   1, 309), S(  -9, 333),
 S( -44, 343), S( -36, 319), S( -21, 342), S( -28, 344),
 S( -15, 318), S(  -9, 307), S( -20, 340), S(  -1, 333),
 S(  -9, 335), S(  -7, 352), S(  -4, 351), S( -23, 365),
 S(   4, 304), S( -15, 358), S( -12, 350), S( -18, 371),
 S(  -1, 287), S(  -2, 307), S(  -6, 325), S( -10, 325),
 S(   4, 257), S(   1, 268), S(   7, 269), S(   5, 283),
 S(  -7, 277), S( -10, 273), S(  -7, 276), S(  -4, 280),
},{
 S(  38, 288), S(  92, 267), S(-107, 396), S(   5, 297),
 S(  27, 282), S(   5, 275), S( -14, 328), S( -34, 355),
 S(  25, 280), S(   0, 274), S(  17, 296), S(  -8, 335),
 S(  -1, 310), S(   6, 318), S(  23, 285), S( -15, 359),
 S(   9, 282), S(   4, 309), S(   8, 312), S( -13, 365),
 S(   6, 248), S(  11, 276), S(  12, 298), S(  -4, 322),
 S(  29, 210), S(  24, 211), S(  18, 238), S(  10, 279),
 S(  21, 242), S( -11, 261), S(  -6, 245), S(   0, 262),
}};

const Score KING_PSQT[2][32] = {{
 S( 226,-134), S( 135, -58), S( -20, -15), S( 103, -41),
 S( -97,  58), S( -32,  70), S(   0,  56), S(  38,  23),
 S(  13,  43), S(  -3,  75), S(  28,  64), S(  -9,  67),
 S(  19,  39), S(  12,  61), S(  -9,  61), S( -19,  53),
 S( -26,  25), S(  20,  38), S(  33,  31), S( -29,  34),
 S( -25,  -2), S(   2,  14), S(  -2,  11), S( -12,   5),
 S(   5, -23), S( -22,  11), S( -23,  -4), S( -29, -13),
 S(  12, -81), S(  18, -38), S(   7, -37), S( -48, -35),
},{
 S( -23,-136), S(-295,  56), S(   8, -35), S( -43, -35),
 S(-211,  16), S( -89,  87), S( -73,  69), S( 146,  14),
 S(-115,  30), S(  42,  86), S( 146,  70), S(  84,  60),
 S( -93,  17), S(  15,  58), S(   4,  72), S(   5,  57),
 S( -79,   3), S( -48,  38), S(   6,  36), S(  -8,  35),
 S(  -4, -15), S(  24,  11), S(   8,  12), S(  14,   7),
...
const Score ROOK_MOBILITIES[15] = {
 S( -83, -66), S( -98, 149), S( -82, 185), S( -75, 190),
 S( -77, 213), S( -73, 221), S( -78, 231), S( -73, 232),
 S( -69, 238), S( -64, 242), S( -61, 246), S( -63, 251),
 S( -60, 253), S( -51, 257), S( -38, 249),};

const Score QUEEN_MOBILITIES[28] = {
 S(-1868,-1381), S(-130,-316), S( -76, 133), S( -52, 261),
 S( -41, 301), S( -35, 312), S( -36, 345), S( -36, 369),
 S( -34, 388), S( -31, 393), S( -29, 399), S( -26, 400),
 S( -27, 407), S( -23, 407), S( -26, 410), S( -20, 401),
 S( -22, 402), S( -25, 403), S( -19, 382), S(  -2, 353),
 S(  15, 318), S(  29, 278), S(  65, 244), S( 109, 154),
 S(  72, 163), S( 203,  30), S(  32,  44), S(  56,  -6),
};
...
const Score QUEEN_ROOK_BATTERY = S(-7, 13);
...
const Score ROOK_THREATS[6] = { S(1, 21), S(31, 43), S(31, 55), S(3, 22), S(81, 3), S(0, 0),};
...
const Score IMBALANCE[5][5] = {
 ...
 { S(56, 47), S(-68, 15), S(-12, 81), S(-207, 158), S(0, 0),},
};

const Score PAWN_SHELTER[4][8] = {
 { S(-21, -4), S(15, 95), S(-3, 50), S(-14, 7), S(8, -5), S(37, -26), S(34, -49), S(0, 0),},
 { S(-44, 1), S(-8, 74), S(-22, 44), S(-31, 20), S(-27, 7), S(24, -19), S(32, -33), S(0, 0),},
 { S(-22, -12), S(-2, 87), S(-37, 34), S(-13, 6), S(-15, -5), S(-4, -9), S(29, -21), S(0, 0),},
 { S(-39, 17), S(12, 76), S(-61, 35), S(-31, 29), S(-29, 22), S(-17, 13), S(-26, 23), S(0, 0),},
};

const Score PAWN_STORM[4][8] = {
 { S(-21, -12), S(-23, -3), S(-24, -8), S(-28, 3), S(-56, 29), S(57, 80), S(275, 73), S(0, 0),},
 { S(-13, -1), S(3, -7), S(3, -5), S(-12, 8), S(-27, 20), S(-31, 83), S(94, 129), S(0, 0),},
 { S(25, -5), S(27, -8), S(24, -5), S(7, 4), S(-15, 17), S(-48, 75), S(62, 95), S(0, 0),},
 { S(-3, -5), S(3, -12), S(15, -10), S(4, -12), S(-18, 4), S(-17, 47), S(-35, 119), S(0, 0),},
};

const Score BLOCKED_PAWN_STORM[8] = {
 S(0, -44), S(37, -52), S(19, -37), S(16, -31), S(4, -25), S(5, -84), S(0, 0), S(0, 0),
};
  ...
  for (int p = KNIGHT[side]; p <= KING[side]; p += 2) {
    ...
    while (pieces) {
      ...
      if (pieceType == KNIGHT_TYPE) {
        ...
        if (FILE_MASKS[file(sq)] & board->pieces[ROOK[side]] && !(FILE_MASKS[file(sq)] & myPawns)) {
