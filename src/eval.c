...
const Score PAWN_PSQT[2][32] = {{
 ...
 S(  80, 134), S(  60, 153), S(  79,  99), S(  84,  79),
 S(  78, 116), S(  77, 103), S(  64,  86), S(  59,  78),
 S(  73,  91), S(  68,  94), S(  65,  80), S(  72,  81),
 S(  66,  82), S(  65,  86), S(  63,  81), S(  66,  90),
 S(  74,  87), S(  78,  92), S(  76,  85), S(  82,  88),
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
},{
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
 S( 156, 151), S(  53, 157), S( 162, 148), S(  98, 195),
 S(  92,  82), S( 100,  74), S( 116,  49), S(  91,  67),
 S(  67,  79), S(  83,  73), S(  66,  64), S(  83,  67),
 S(  56,  71), S(  72,  77), S(  63,  69), S(  83,  73),
 S(  38,  70), S(  69,  72), S(  66,  75), S(  76,  85),
 S(  47,  81), S(  85,  83), S(  76,  83), S(  84,  98),
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
}};

const Score KNIGHT_PSQT[2][32] = {{
 S(-189,  54), S(-194,  75), S(-164,  84), S(-124,  64),
 S(-117,  82), S( -98,  86), S( -73,  69), S( -68,  70),
 S( -59,  64), S( -66,  72), S( -68,  81), S( -80,  83),
 S( -71,  89), S( -65,  81), S( -53,  80), S( -64,  84),
 S( -71,  82), S( -64,  78), S( -51,  87), S( -59,  87),
 S( -92,  62), S( -82,  61), S( -74,  69), S( -76,  84),
 S(-103,  63), S( -86,  59), S( -83,  66), S( -78,  65),
 S(-126,  71), S( -90,  61), S( -89,  63), S( -81,  75),
},{
 S(-242, -96), S(-290,  51), S(-139,  34), S( -69,  60),
 S( -90,  16), S( -20,  38), S( -59,  68), S( -77,  72),
 S( -46,  34), S( -87,  50), S( -34,  30), S( -48,  63),
 S( -61,  66), S( -58,  62), S( -51,  68), S( -59,  80),
 S( -67,  79), S( -75,  70), S( -48,  81), S( -64,  95),
 S( -72,  56), S( -58,  53), S( -67,  61), S( -62,  80),
 S( -73,  57), S( -62,  56), S( -75,  58), S( -77,  62),
 S( -82,  66), S( -95,  63), S( -76,  57), S( -73,  72),
}};

const Score BISHOP_PSQT[2][32] = {{
 S( -23, 114), S( -41, 134), S( -29, 116), S( -44, 131),
 S(   1, 118), S( -16, 104), S(  24, 110), S(   9, 122),
 S(  18, 121), S(  19, 121), S( -12, 103), S(  23, 110),
 S(  11, 119), S(  34, 113), S(  25, 116), S(  16, 134),
 S(  31, 104), S(  22, 116), S(  29, 116), S(  39, 112),
 S(  26,  96), S(  43, 109), S(  28,  93), S(  31, 110),
 S(  29,  93), S(  28,  66), S(  42,  84), S(  26, 104),
 S(  22,  72), S(  40,  88), S(  28, 105), S(  33, 104),
},{
 S( -61,  77), S(  41,  99), S( -35, 106), S( -63, 111),
 S(   5,  74), S( -28, 103), S(  -9, 121), S(  22, 102),
 S(  39, 106), S(   7, 109), S(   9, 104), S(  21, 112),
 S(   7, 103), S(  35, 108), S(  38, 112), S(  35, 113),
 S(  47,  81), S(  37, 105), S(  41, 113), S(  33, 115),
 S(  39,  86), S(  55,  97), S(  36,  94), S(  32, 120),
 S(  41,  68), S(  40,  68), S(  42,  99), S(  34, 104),
 S(  40,  50), S(  30, 123), S(  23, 111), S(  40, 102),
}};

const Score ROOK_PSQT[2][32] = {{
 S( -97, 237), S( -89, 241), S( -90, 245), S(-117, 247),
 S( -88, 231), S( -93, 241), S( -76, 240), S( -60, 223),
 S(-101, 239), S( -66, 232), S( -78, 234), S( -76, 227),
 S( -95, 252), S( -80, 248), S( -67, 245), S( -64, 228),
 S( -98, 247), S( -90, 247), S( -86, 244), S( -78, 234),
 S(-102, 236), S( -91, 224), S( -86, 227), S( -85, 224),
 S( -98, 221), S( -93, 225), S( -80, 223), S( -77, 214),
 S(-100, 230), S( -92, 222), S( -91, 228), S( -83, 213),
},{
 S( -36, 221), S( -87, 246), S(-145, 257), S( -89, 238),
 S( -65, 211), S( -53, 223), S( -76, 228), S( -89, 229),
 S( -91, 216), S( -36, 210), S( -63, 204), S( -44, 205),
 S( -83, 223), S( -49, 219), S( -58, 208), S( -55, 218),
 S(-102, 221), S( -82, 222), S( -83, 216), S( -69, 222),
 S( -90, 195), S( -71, 195), S( -77, 199), S( -72, 211),
 S( -85, 197), S( -62, 185), S( -74, 194), S( -71, 203),
 S( -98, 210), S( -76, 203), S( -83, 204), S( -75, 203),
}};

const Score QUEEN_PSQT[2][32] = {{
 S(-113, 403), S( -31, 306), S(   4, 308), S(  -5, 332),
 S( -44, 344), S( -33, 317), S( -18, 342), S( -25, 344),
 S( -12, 317), S(  -5, 306), S( -16, 339), S(   4, 331),
 S( -10, 336), S(  -6, 353), S(  -1, 350), S( -16, 360),
 S(   3, 306), S( -13, 358), S( -10, 349), S( -19, 374),
 S(  -3, 290), S(  -1, 307), S(  -5, 326), S( -10, 326),
 S(   1, 259), S(  -1, 271), S(   4, 272), S(   4, 285),
 S( -11, 279), S( -13, 275), S(  -9, 277), S(  -7, 285),
},{
 S(  35, 290), S(  95, 266), S(-102, 394), S(   7, 297),
 S(  27, 283), S(   7, 274), S( -12, 328), S( -30, 354),
 S(  28, 277), S(   4, 272), S(  21, 295), S(  -2, 332),
 S(  -1, 311), S(   7, 318), S(  24, 286), S(  -7, 353),
 S(   8, 284), S(   6, 308), S(  11, 312), S( -12, 366),
 S(   5, 251), S(  13, 274), S(  12, 301), S(  -3, 322),
 S(  26, 213), S(  23, 214), S(  17, 240), S(   9, 282),
 S(  16, 246), S( -14, 263), S(  -9, 247), S(  -2, 264),
}};

const Score KING_PSQT[2][32] = {{
 S( 229,-134), S( 134, -58), S( -18, -15), S( 103, -41),
 S( -96,  58), S( -33,  70), S(   0,  56), S(  37,  23),
 S(  13,  43), S(  -3,  75), S(  27,  64), S(  -9,  67),
 S(  18,  39), S(  12,  61), S(  -9,  61), S( -19,  53),
 S( -26,  24), S(  19,  38), S(  33,  31), S( -28,  34),
 S( -26,  -2), S(   2,  14), S(  -2,  11), S( -12,   5),
 S(   5, -23), S( -22,  11), S( -24,  -4), S( -29, -13),
 S(  12, -81), S(  18, -38), S(   7, -37), S( -48, -35),
},{
 S( -23,-136), S(-295,  56), S(   9, -35), S( -42, -35),
 S(-209,  16), S( -89,  87), S( -73,  69), S( 146,  14),
 S(-116,  30), S(  42,  86), S( 146,  70), S(  85,  60),
 S( -93,  17), S(  15,  58), S(   4,  72), S(   5,  57),
 S( -79,   4), S( -48,  38), S(   6,  36), S(  -7,  35),
...
const Score KNIGHT_POST_PSQT[12] = {
 S( -48,   9), S(   6,  18), S(  28,  23), S(  60,  35),
 S(  13,  -4), S(  39,  18), S(  29,  26), S(  41,  35),
 S(  21,  -3), S(  35,   9), S(  20,  15), S(  20,  23),
};

const Score BISHOP_POST_PSQT[12] = {
 S(  -7,   6), S(  22,   3), S(  58,  11), S(  61,   6),
 S(   1,  -2), S(  25,  11), S(  41,   3), S(  51,   9),
 S(  -7,  23), S(  43,   6), S(  31,  12), S(  38,  20),
};

const Score KNIGHT_MOBILITIES[9] = {
 S(-159, -30), S(-117,  43), S( -99,  83), S( -87,  97),
 S( -79, 110), S( -71, 122), S( -63, 125), S( -55, 127),
 S( -47, 117),};

const Score BISHOP_MOBILITIES[14] = {
 S( -11,  53), S(  13,  80), S(  25, 101), S(  32, 123),
 S(  39, 132), S(  43, 142), S(  45, 149), S(  49, 152),
 S(  49, 154), S(  53, 155), S(  61, 152), S(  74, 147),
 S(  74, 153), S(  84, 138),};

const Score ROOK_MOBILITIES[15] = {
 S( -82, -65), S( -96, 148), S( -81, 184), S( -74, 190),
 S( -76, 212), S( -72, 220), S( -76, 230), S( -72, 232),
 S( -68, 238), S( -63, 242), S( -60, 246), S( -62, 251),
 S( -58, 252), S( -50, 257), S( -37, 249),};

const Score QUEEN_MOBILITIES[28] = {
 S(-1870,-1381), S(-125,-322), S( -76, 137), S( -54, 266),
 S( -42, 305), S( -37, 316), S( -37, 349), S( -37, 372),
 S( -35, 390), S( -32, 395), S( -30, 401), S( -27, 402),
 S( -28, 409), S( -24, 408), S( -26, 411), S( -21, 403),
 S( -23, 404), S( -26, 404), S( -20, 384), S(  -3, 355),
 S(  14, 320), S(  28, 280), S(  64, 246), S( 109, 155),
 S(  71, 165), S( 199,  33), S(  28,  48), S(  57,  -4),
};
...
const Score BISHOP_TRAPPED = S(-120, -241);
...
const Score PASSED_PAWN[8] = {
 S(   0,   0), S( 118, 186), S(  42, 184), S(  12, 114),
...
const Score KNIGHT_THREATS[6] = { S(0, 19), S(-5, 42), S(35, 37), S(86, 9), S(69, -47), S(0, 0),};

const Score BISHOP_THREATS[6] = { S(3, 19), S(23, 37), S(-64, 77), S(69, 21), S(80, 89), S(0, 0),};
...
const Score KNIGHT_CHECK_QUEEN = S(11, 1);
...
const Score IMBALANCE[5][5] = {
 ...
 { S(-1, 35), S(-32, -24), S(-5, -1), S(0, 0),},
 { S(56, 47), S(-69, 19), S(-13, 80), S(-206, 157), S(0, 0),},
};

const Score PAWN_SHELTER[4][8] = {
 { S(-21, -4), S(15, 95), S(-3, 50), S(-13, 7), S(8, -5), S(37, -26), S(34, -49), S(0, 0),},
 { S(-44, 1), S(-10, 74), S(-22, 44), S(-31, 20), S(-27, 7), S(24, -19), S(32, -33), S(0, 0),},
 { S(-23, -12), S(-3, 87), S(-38, 34), S(-14, 7), S(-15, -4), S(-4, -9), S(29, -21), S(0, 0),},
 { S(-39, 17), S(12, 75), S(-61, 35), S(-31, 29), S(-29, 22), S(-17, 13), S(-26, 22), S(0, 0),},
};

const Score PAWN_STORM[4][8] = {
 { S(-21, -12), S(-23, -3), S(-24, -8), S(-28, 3), S(-56, 29), S(57, 80), S(274, 72), S(0, 0),},
 { S(-13, -1), S(3, -7), S(3, -5), S(-12, 8), S(-27, 20), S(-31, 83), S(93, 129), S(0, 0),},
 { S(24, -4), S(26, -8), S(23, -5), S(7, 4), S(-15, 17), S(-48, 75), S(62, 95), S(0, 0),},
 { S(-3, -5), S(3, -13), S(15, -11), S(4, -12), S(-18, 4), S(-17, 46), S(-36, 119), S(0, 0),},
};

const Score BLOCKED_PAWN_STORM[8] = {
 S(1, -45), S(36, -52), S(18, -37), S(16, -32), S(4, -25), S(5, -84), S(0, 0), S(0, 0),
};
