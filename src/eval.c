...
const Score PAWN_PSQT[2][32] = {{
 ...
 S(  80, 134), S(  60, 153), S(  80,  99), S(  85,  79),
 S(  78, 116), S(  77, 103), S(  65,  86), S(  60,  78),
 S(  73,  91), S(  69,  94), S(  65,  80), S(  72,  81),
 S(  66,  83), S(  65,  86), S(  64,  81), S(  66,  90),
 S(  75,  87), S(  79,  92), S(  76,  85), S(  83,  88),
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
},{
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
 S( 157, 152), S(  52, 158), S( 163, 148), S(  98, 195),
 S(  93,  82), S( 101,  74), S( 117,  49), S(  91,  67),
 S(  68,  79), S(  83,  73), S(  66,  64), S(  84,  67),
 S(  57,  71), S(  73,  77), S(  63,  70), S(  83,  73),
 S(  39,  70), S(  69,  72), S(  67,  75), S(  76,  85),
 S(  48,  81), S(  85,  83), S(  76,  83), S(  84,  99),
 S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
}};

const Score KNIGHT_PSQT[2][32] = {{
 S(-188,  54), S(-193,  75), S(-164,  84), S(-122,  64),
 S(-113,  81), S( -96,  86), S( -72,  69), S( -68,  70),
 S( -58,  63), S( -64,  71), S( -67,  81), S( -76,  81),
 S( -68,  89), S( -65,  81), S( -49,  78), S( -63,  83),
 S( -70,  82), S( -62,  77), S( -50,  87), S( -56,  86),
 S( -91,  61), S( -82,  61), S( -73,  69), S( -75,  84),
 S(-102,  63), S( -86,  59), S( -83,  66), S( -77,  65),
 S(-125,  71), S( -89,  61), S( -89,  62), S( -80,  74),
},{
 S(-241, -96), S(-288,  50), S(-136,  34), S( -67,  60),
 S( -90,  16), S( -19,  38), S( -58,  68), S( -75,  72),
 S( -44,  33), S( -87,  50), S( -34,  30), S( -47,  62),
 S( -61,  66), S( -56,  61), S( -51,  69), S( -55,  78),
 S( -65,  79), S( -74,  70), S( -47,  81), S( -63,  95),
 S( -71,  56), S( -57,  53), S( -67,  61), S( -60,  79),
 S( -72,  57), S( -61,  56), S( -75,  58), S( -77,  62),
 S( -81,  66), S( -94,  64), S( -75,  57), S( -72,  71),
}};

const Score BISHOP_PSQT[2][32] = {{
 S( -22, 114), S( -41, 135), S( -29, 116), S( -44, 131),
 S(   1, 118), S( -15, 104), S(  24, 109), S(   9, 122),
 S(  18, 121), S(  20, 121), S( -11, 103), S(  23, 110),
 S(  12, 119), S(  35, 113), S(  26, 116), S(  17, 133),
 S(  31, 104), S(  22, 115), S(  29, 116), S(  39, 112),
 S(  26,  96), S(  43, 109), S(  28,  93), S(  31, 110),
 S(  30,  93), S(  29,  65), S(  42,  85), S(  26, 104),
 S(  22,  72), S(  40,  88), S(  29, 105), S(  33, 104),
},{
 S( -61,  76), S(  38, 100), S( -35, 106), S( -63, 111),
 S(   5,  74), S( -28, 103), S(  -8, 121), S(  22, 102),
 S(  39, 106), S(   8, 109), S(  10, 104), S(  22, 111),
 S(   8, 103), S(  36, 108), S(  38, 112), S(  35, 113),
 S(  47,  81), S(  37, 105), S(  41, 113), S(  34, 115),
 S(  39,  86), S(  56,  96), S(  36,  94), S(  32, 120),
 S(  42,  68), S(  40,  68), S(  42,  99), S(  35, 104),
 S(  41,  50), S(  31, 123), S(  23, 111), S(  41, 102),
}};

const Score ROOK_PSQT[2][32] = {{
 S( -98, 237), S( -90, 242), S( -91, 245), S(-118, 247),
 S( -89, 231), S( -94, 241), S( -77, 240), S( -61, 223),
 S(-102, 239), S( -67, 232), S( -78, 234), S( -76, 227),
 S( -96, 252), S( -81, 248), S( -67, 245), S( -64, 228),
 S( -99, 247), S( -92, 247), S( -87, 244), S( -79, 233),
 S(-103, 236), S( -92, 224), S( -87, 227), S( -85, 224),
 S( -99, 221), S( -94, 226), S( -81, 223), S( -78, 214),
 S(-101, 230), S( -93, 222), S( -92, 228), S( -84, 213),
},{
 S( -36, 221), S( -88, 246), S(-145, 257), S( -90, 238),
 S( -66, 211), S( -54, 223), S( -76, 228), S( -90, 229),
 S( -92, 216), S( -36, 210), S( -63, 204), S( -44, 205),
 S( -85, 223), S( -50, 219), S( -59, 208), S( -56, 218),
 S(-103, 221), S( -82, 222), S( -84, 216), S( -69, 222),
 S( -91, 195), S( -72, 195), S( -78, 199), S( -73, 211),
 S( -85, 197), S( -63, 185), S( -75, 194), S( -72, 203),
 S( -99, 210), S( -77, 203), S( -84, 204), S( -76, 204),
}};

const Score QUEEN_PSQT[2][32] = {{
 S(-112, 402), S( -32, 307), S(   2, 309), S(  -7, 333),
 S( -44, 344), S( -36, 319), S( -21, 343), S( -29, 345),
 S( -15, 318), S(  -9, 307), S( -20, 341), S(  -1, 334),
 S(  -9, 335), S(  -7, 352), S(  -5, 352), S( -24, 366),
 S(   4, 304), S( -15, 358), S( -13, 350), S( -19, 372),
 S(  -1, 287), S(  -2, 307), S(  -6, 325), S( -10, 325),
 S(   3, 257), S(   0, 268), S(   6, 269), S(   5, 283),
 S(  -9, 277), S( -10, 272), S(  -7, 274), S(  -4, 279),
},{
 S(  37, 289), S(  92, 267), S(-106, 396), S(   5, 298),
 S(  26, 283), S(   5, 275), S( -14, 328), S( -35, 356),
 S(  25, 280), S(   0, 274), S(  17, 297), S(  -8, 336),
 S(  -1, 310), S(   6, 318), S(  22, 286), S( -16, 359),
 S(   9, 282), S(   4, 310), S(   8, 313), S( -13, 365),
 S(   6, 248), S(  11, 276), S(  12, 299), S(  -4, 322),
 S(  27, 211), S(  24, 211), S(  18, 238), S(  10, 279),
 S(  17, 244), S( -12, 260), S(  -7, 245), S(   1, 260),
}};

const Score KING_PSQT[2][32] = {{
 S( 227,-134), S( 134, -58), S( -20, -15), S( 103, -41),
 S( -96,  58), S( -33,  70), S(   0,  56), S(  37,  23),
 S(  13,  43), S(  -3,  75), S(  28,  64), S(  -9,  67),
 S(  19,  39), S(  12,  61), S(  -9,  61), S( -19,  53),
 S( -26,  24), S(  19,  38), S(  33,  31), S( -29,  34),
 ...
 S(-116,  30), S(  42,  86), S( 146,  70), S(  83,  60),
 S( -93,  17), S(  15,  58), S(   4,  72), S(   5,  57),
 S( -79,   3), S( -48,  38), S(   6,  36), S(  -8,  35),
 S(  -5, -15), S(  24,  11), S(   8,  12), S(  15,   7),
 S(  13, -15), S(   8,  10), S(  -5,   0), S( -19, -10),
 S(  16, -63), S(  17, -16), S(   4, -25), S( -32, -34),
}};

const Score KNIGHT_POST_PSQT[12] = {
 S( -47,   8), S(   7,  18), S(  29,  22), S(  60,  35),
 S(  14,  -5), S(  40,  18), S(  30,  26), S(  41,  35),
 S(  21,  -3), S(  35,   9), S(  21,  15), S(  21,  22),
};

const Score BISHOP_POST_PSQT[12] = {
 S(  -7,   6), S(  22,   3), S(  58,  12), S(  61,   6),
 S(   0,  -2), S(  25,  11), S(  41,   3), S(  51,   9),
...
const Score BISHOP_MOBILITIES[14] = {
 S( -11,  53), S(  13,  80), S(  25, 101), S(  32, 122),
 S(  39, 131), S(  43, 142), S(  45, 149), S(  49, 151),
 S(  50, 154), S(  53, 155), S(  61, 151), S(  74, 146),
 S(  74, 153), S(  85, 138),};

const Score ROOK_MOBILITIES[15] = {
 S( -82, -66), S( -97, 149), S( -81, 184), S( -75, 190),
 S( -77, 212), S( -72, 221), S( -77, 230), S( -73, 232),
 S( -69, 238), S( -64, 242), S( -61, 246), S( -63, 251),
 S( -59, 253), S( -51, 257), S( -38, 249),};

const Score QUEEN_MOBILITIES[28] = {
 S(-1869,-1381), S(-129,-316), S( -75, 134), S( -52, 261),
 S( -41, 301), S( -35, 312), S( -36, 345), S( -36, 369),
 S( -34, 388), S( -31, 393), S( -29, 399), S( -26, 400),
 S( -27, 407), S( -24, 407), S( -26, 410), S( -20, 401),
 S( -23, 403), S( -25, 403), S( -19, 382), S(  -3, 353),
 S(  15, 318), S(  29, 278), S(  65, 244), S( 109, 153),
 S(  72, 163), S( 201,  30), S(  32,  44), S(  57,  -7),
};
...
const Score QUEEN_ROOK_BATTERY = S(11, 37);
...
const Score PASSED_PAWN_ADVANCE_DEFENDED[5] = {
 S(   0,   0), S(  88, 262), S(  16, 138), S(   8,  47), S(  12,  10),
};
...
const Score BISHOP_THREATS[6] = { S(2, 19), S(23, 37), S(-63, 77), S(69, 21), S(79, 90), S(0, 0),};

const Score ROOK_THREATS[6] = { S(1, 22), S(31, 43), S(31, 55), S(3, 22), S(81, 0), S(0, 0),};
...
const Score IMBALANCE[5][5] = {
 ...
 { S(56, 47), S(-68, 15), S(-13, 80), S(-206, 157), S(0, 0),},
};

const Score PAWN_SHELTER[4][8] = {
 { S(-21, -4), S(15, 95), S(-3, 50), S(-14, 7), S(8, -5), S(37, -26), S(34, -49), S(0, 0),},
 { S(-44, 1), S(-9, 73), S(-22, 44), S(-31, 20), S(-27, 7), S(24, -19), S(32, -33), S(0, 0),},
 { S(-23, -12), S(-3, 87), S(-37, 34), S(-13, 6), S(-15, -4), S(-4, -9), S(29, -21), S(0, 0),},
...
const Score PAWN_STORM[4][8] = {
 ...
 { S(25, -5), S(26, -8), S(24, -5), S(7, 4), S(-15, 17), S(-48, 75), S(63, 94), S(0, 0),},
 { S(-3, -5), S(3, -12), S(15, -11), S(4, -12), S(-18, 4), S(-17, 46), S(-35, 119), S(0, 0),},
};

const Score BLOCKED_PAWN_STORM[8] = {
 S(1, -44), S(37, -52), S(18, -37), S(16, -32), S(4, -25), S(5, -84), S(0, 0), S(0, 0),
};
