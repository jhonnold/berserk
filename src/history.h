...
INLINE int GetThreatenedCorrection(Board* board, ThreadData* thread) {
  return thread->threatenedCorrection[board->threatenedZobrist & THREATENED_CORRECTION_MASK] / CORRECTION_GRAIN;
}
